...
class mb_specialModel extends Model
{
    ...
    private function _formatMbSpecialData($item_data, $item_type)
    {
        switch ($item_type) {
            ...
            case 'nav':
                $item_datas = array();
                $item_datas['item'] = $item_data;
                $item_data = array();
                $item_data = $item_datas;
                foreach ($item_data['item'] as &$values) {
                    $values['image_name'] = getMbSpecialImageUrl($values['image_name']);
                }
                break;
            case 'goods':
            case 'goods1':
    ...
    private function _initMbSpecialItemData($item_data, $item_type)
    {
        if (!empty($item_data)) {
            ...
            if ($item_type == 'goods' || $item_type == 'goods1' || $item_type == 'goods2' || $item_type == 'goods3' || $item_type == 'goods4') {
    ...
    public function getMbSpecialModuleList()
    {
        ...
        $module_list['nav'] = array('name' => 'nav', 'desc' => '导航版块', 'type' => 3);
        ...
        $module_list['home7'] = array('name' => 'home7', 'desc' => '模型版块布局G');
        $module_list['home8'] = array('name' => 'home8', 'desc' => '模型版块布局H');
        $module_list['home9'] = array('name' => 'home9', 'desc' => '模型版块布局I');
        $module_list['home10'] = array('name' => 'home10', 'desc' => '模型版块布局J');
        $module_list['home11'] = array('name' => 'home11', 'desc' => '模型版块布局K');
        $module_list['home12'] = array('name' => 'home12', 'desc' => '倒计时广告条');
        $module_list['home13'] = array('name' => 'home13', 'desc' => '公告滚动条');
        $module_list['home14'] = array('name' => 'home14', 'desc' => '底部漂浮可关闭广告');
        $module_list['home15'] = array('name' => 'home15', 'desc' => '三图模版');
        $module_list['home16'] = array('name' => 'home16', 'desc' => '四图模版');
        $module_list['home17'] = array('name' => 'home17', 'desc' => ' 滑动图片广告');
        $module_list['home18'] = array('name' => 'home18', 'desc' => '五图模版');
        $module_list['goods'] = array('name' => 'goods', 'desc' => '商品版块');
        $module_list['goods1'] = array('name' => 'goods1', 'desc' => '限时商品', 'type' => 1);
        $module_list['goods2'] = array('name' => 'goods2', 'desc' => '特卖商品', 'type' => 2);
        $module_list['goods3'] = array('name' => 'goods3', 'desc' => '4格商品版块');
        $module_list['goods4'] = array('name' => 'goods4', 'desc' => '3格商品版块');
