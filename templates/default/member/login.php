  ...
  <div class="arrow"></div>
    <div class="nc-login-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        ...
        <?php if (C('sms_login') == 1){?>
        <div id="mobile" class="tabs-content hide">
    ...
    <div class="nc-login-api" id="demo-form-site">
      ...
      <?php if (C('qq_isuse') == 1){?>
      <a href="<?php echo SHOP_SITE_URL;?>/api.php?con=toqq" title="QQ账号登录" class="qq"><i></i>QQ</a>
      <?php } ?>
      <?php if (C('sina_isuse') == 1){?>
      <a href="<?php echo SHOP_SITE_URL;?>/api.php?con=tosina" title="新浪微博账号登录" class="sina"><i></i>新浪微博</a>
      <?php } ?>
