...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="con" value="stat_marketing" />
      <input type="hidden" name="fun" value="promotion" />
...
function getLineLabels(stattype){
	...
	if(!$("#"+stattype+'_div').html()){
		$("#"+stattype+'_div').load('index.php?con=stat_marketing&fun=promotiontrend&search_type='+search_type+'&stattype='+stattype+'&t=<?php echo $output['searchtime'];?>');
	}
}
</script>