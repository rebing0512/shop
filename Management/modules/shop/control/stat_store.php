...
class stat_storeControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_store&fun=newstore','lang'=>'stat_newstore'),
        array('url'=>'con=stat_store&fun=hotrank','lang'=>'stat_storehotrank'),
        array('url'=>'con=stat_store&fun=storesales','lang'=>'stat_storesales'),
        array('url'=>'con=stat_store&fun=degree','lang'=>'stat_storedegree'),
        array('url'=>'con=stat_store&fun=storearea','lang'=>'stat_storearea'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($_REQUEST['fun'],array('hotrank','storesales','get_storesales_xml','storesales_list','storesales_trends'))){
    ...
    public function newstoreOp(){
        //导出excel连接地址
        $actionurl = 'index.php?con=stat_store&fun=newstore';
        $where = array();
        //所属店铺分类
    ...
    public function showstoreOp(){
        ...
        $this->links[] = array('url'=>'con=stat_store&fun=showstore','lang'=>'stat_storelist');
    ...
    public function storeareaOp(){
        ...
        Tpl::output('stat_json',$stat_json);
        Tpl::output('statlist',$statlist);
        $actionurl = 'index.php?con=stat_store&fun=showstore&type=storearea';
        if (trim($_GET['search_time'])){
