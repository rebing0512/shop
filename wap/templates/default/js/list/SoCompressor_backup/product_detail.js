...
$(function() {
    ...
    function r(r) {
        $.ajax({
            url: ApiUrl + "/index.php?con=goods&fun=goods_detail",
            type: "get",
            data: {
                goods_id: r,
                key: e
                ...
                if (!l.error) {
                    ...
                    if (l.goods_info.is_virtual == "1") {
                        $("#buy-now").click(function() {
                            ...
                            $.ajax({
                                type: "post",
                                url: ApiUrl + "/index.php?con=member_vr_buy&fun=buy_step1",
                                data: o,
                                dataType: "json",
                                success: function(e) {
                                    if (e.datas.error) {                               
                                        ...
                                        location.href = WapSiteUrl + "/index.php?con=member_buy&fun=vr_buy_step1_index&goods_id=" + r + "&quantity=" + t
                                    }
                                }
                            })
                        })
                                ...
                                $.ajax({
                                    ...
                                    success: function(e) {
                                        if (e.datas.error) {
                                            ...
                                            location.href = WapSiteUrl + "/index.php?con=member_buy&fun=index&goods_id=" + r + "&buynum=" + t
                                        }
                                    }
                                })
                            }
    ...
    function() {
        $.areaSelected({
            success: function(e) {
                ...
                $.getJSON(ApiUrl + "/index.php?con=goods&fun=calc", {
                    goods_id: goods_id,
                    area_id: t
                },
                function(e) {
    ...
    function() {
        window.location.href = ApiUrl + "/index.php?con=goods&fun=goods_body&goods_id=" + goods_id
    });
    ...
    function() {
       window.location.href = ApiUrl + "/index.php?con=goods&fun=goods_evaluate&goods_id=" + goods_id;
    });
...
function virtual() {
    ...
    $.getJSON(ApiUrl + "/index.php?con=goods&fun=store_o2o_addr", {
        store_id: store_id
    },
    function(e) {
        if (!e.datas.error) {
