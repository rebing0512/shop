...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=sns_strace" title="返回动态列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=sns_strace&fun=get_scomm_xml&id=<?php echo $_GET['st_id'];?>',
        colModel : [
...
function fg_del(id) {
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?con=sns_strace&fun=scomm_del', {id:id}, function(data){
            if (data.state) {
