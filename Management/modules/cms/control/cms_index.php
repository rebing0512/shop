...
Tpl::showpage('cms_index.template', 'null_layout');
    ...
    public function save_page_moduleOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('nc_common_save_succ'), 'index.php?con=cms_index&fun=cms_index');
        } else {
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'cms_index'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?con=cms_index&fun=cms_index'),
        );
