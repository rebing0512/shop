...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="index.php?con=cms_picture&fun=cms_picture_verify">
...
$(function(){
    ...
    var flexUrl = 'index.php?con=cms_picture&fun=cms_picture_list_xml&picture_state=<?php echo $output['currentState']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?con=cms_picture&fun=cms_picture_drop&picture_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = 'index.php?con=cms_picture&fun=cms_picture_drop&picture_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = 'index.php?con=cms_picture&fun=cms_picture_callback&picture_id=' + id;
});
...
$("a[data-j='picture_commend_flag'],a[data-j='picture_comment_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('index.php?con=cms_picture&fun=ajax', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?con=cms_picture&fun=update_' + column, {
