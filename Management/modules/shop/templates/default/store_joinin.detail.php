...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=store&fun=store_joinin" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
<!--      </tr>-->
  ...
  <form id="form_store_verify" action="index.php?con=store&fun=store_joinin_verify" method="post">
    ...
    <div class="bottom"><a id="btn_pass" class="ncap-btn-big ncap-btn-green mr10" href="index.php?con=store&fun=verify&member_id=<?=$_GET['member_id']?>&id=btn_pass">通过</a><a id="btn_fail" class="ncap-btn-big ncap-btn-red" href="index.php?con=store&fun=verify&member_id=<?=$_GET['member_id']?>&id=btn_fail">拒绝</a> </div>
  </form>
</div>
...
//
//        $('.ncap-btn-big').on('click', function() {
...
//            }
//            if(confirm('确认'+$(this).text()+'申请？')) {
//                $('#verify_type').val('fail');
//                $('#form_store_verify').submit();
//                window.href = '/index.php?con=store&fun=verify'
//                $.ajax({
//                    url:'/index.php?con=store&fun=verify',
//                    type:'post',
//                    data:{
//                        id:$(this).attr('id')
//                    },
...
//                                time:1.5
//                            })
//                            location.href = 'index.php?con=store&fun=store_joinin';
//                        }
//                    }
//                })
//            }
