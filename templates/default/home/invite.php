            ...
            <div class="invite-bd">
                ...
                <div class="invite-form">
                    ...
                    <div class="invite-link">
                        <input type="text" class="std-input i-invite-link" value="<?php echo $_SESSION['member_id'] ? urlShop('login', 'register', array('inviterid' => $_SESSION['member_id'])) : '请先登录'; ?>" readonly>
