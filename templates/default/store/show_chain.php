...
function show_map() {
	$('.delivery-map').html('<img width="740" height="320" src="https://sapi.map.baidu.com/staticimage?center=&width=740&height=320&zoom=18&markers=<?php echo str_replace(' ', '', $output['chain_info']['area_info'].$output['chain_info']['chain_address']);?>">');
}
</script>