...
<meta property="wb:webmaster" content="3e3a56c21ee9b66f" />
<meta name="renderer" content="webkit">
<meta name="renderer" content="ie-stand">
<meta property="qc:admins" content="35711663776164533607" />
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var LOGIN_SITE_URL = '<?php echo LOGIN_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var SITEURL = '<?php echo SHOP_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';
</script>
...
$(function(){
  ...
  $(".head-search-bar li").click(function() {

    var act = "<?php echo $_GET['con']?>";
      if (act == "store_list"){
        $("#head-search-bar").children('ul').children('li:eq(1)').addClass("current");
        $("#head-search-bar").children('ul').children('li:eq(0)').removeClass("current");
        }
      $("#head-search-bar").children('ul').children('li').click(function(){
       ...
       <dl class="my-mall">
        ...
        <dd>
          ...
          <div class="user-centent-menu">
            <ul>
              <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_message&fun=message">站内消息(<span><?php echo $output['message_num']>0 ? $output['message_num']:'0';?></span>)</a></li>
              ...
              <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_voucher">代金券(<span id="member_voucher">0</span>)</a></li>
              <?php } ?>
              <?php if (C('points_isuse') == 1){ ?>
              <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_points" class="arrow">我的积分<i></i></a></li>
              <?php } ?>
            </ul>
          </div>
...
<nav class="public-nav-layout <?php if($output['channel']) {echo 'channel-'.$output['channel']['channel_style'].' channel-'.$output['channel']['channel_id'];} ?>">
  <div class="wrapper">
    ...
    <ul class="site-menu" style="float:left;">
