...
//      //查询会员信息
        ...
        if ($result){
            ...
            if ($_POST['showtype'] == 1){
                $js .="$('#tracereply_".$stid."').load('index.php?con=store_snshome&fun=commenttop&id=".$stid."');";
            }else {
                $js .="$('#tracereply_".$stid."').load('index.php?con=store_snshome&fun=commentlist&id=".$stid."');";
            }
    ...
    public function addforwardOp(){
        ...
        $insert_arr['trace_content']            = "<dl class=\"fd-wrap\">
                                                        <dt>
                                                            <h3><a href=\"index.php?con=store_snshome&sid=".$stracelog_info['strace_storeid']."\" target=\"_blank\">".$stracelog_info['strace_storename']."</a>".Language::get('nc_colon')."
