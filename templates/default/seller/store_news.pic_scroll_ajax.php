<?php defined('TTShop') or exit('Access Invalid!');?>
            ...
            <li> <a href="<?php echo sthumb($v, 1280);?>" value="<?php echo $v['apic_id'] ?>"> <span class="thumb size90"><i></i> <img title="<?php echo $v['apic_name']?>" src="<?php echo sthumb($v, 60);?>" class="image0" onload="javascript:DrawImage(this,90,90);"/>
