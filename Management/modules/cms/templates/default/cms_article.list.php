...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="index.php?con=cms_article&fun=cms_article_verify">
...
$(function(){
    ...
    var flexUrl = 'index.php?con=cms_article&fun=cms_article_list_xml&article_state=<?php echo $output['currentState']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?con=cms_article&fun=cms_article_drop&article_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = 'index.php?con=cms_article&fun=cms_article_drop&article_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = 'index.php?con=cms_article&fun=cms_article_callback&article_id=' + id;
});
...
$("a[data-j='article_commend_flag'],a[data-j='article_commend_image_flag'],a[data-j='article_comment_flag'],a[data-j='article_attitude_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('index.php?con=cms_article&fun=ajax', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?con=cms_article&fun=update_' + column, {
