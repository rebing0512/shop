...
class connect_sinaControl extends mobileHomeControl{
    ...
    public function __construct(){
        ...
        if (C('sina_isuse') != 1){
            ...
            showMessage('系统未开启新浪微博登录功能',urlMobile('login'),'html','error');//'系统未开启QQ互联功能'
    ...
    public function registerOp(){
        ...
        if (chksubmit()){
            ...
            showMessage('登录成功',urlMobile('login'),'html','succ');
    ...
    public function bindsinaOp(){
        ...
        if ($edit_state){
            ...
            showMessage('绑定新浪微博成功',urlMobile('login'),'html','succ');

        }else {

           showMessage('绑定新浪失败',urlMobile('login'),'html','error');//'绑定QQ失败'
