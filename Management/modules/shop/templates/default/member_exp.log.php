  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?con=member_exp&fun=expsetting">规则设置</a></li>
        <li><a href="index.php?con=member_exp&fun=member_grade">等级设定</a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=member_exp&fun=get_xml',
        colModel : [
