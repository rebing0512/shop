      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"> <span class="show"> <a class="nyroModal" href="<?php echo UPLOAD_SITE_URL."/".ATTACH_BRAND_BIG."/".$output['brand_array']['brand_bigpic'];?>" rel="gal"> <i class="fa fa-picture-o" onmouseout="toolTip()" onmouseover="toolTip('<img src=<?php echo UPLOAD_SITE_URL."/".ATTACH_BRAND_BIG."/".$output['brand_array']['brand_bigpic'];?>>')"></i> </a> </span> <span class="type-file-box">
            ...
            <input type="hidden" name="pic_ori" value="<?php echo $output['brand_array']['brand_bigpic'];?>">
          </div>
          <span class="err"></span>
