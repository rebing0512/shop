<?php defined('TTShop') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='act' name="con" value='store_bill' />
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?con=store_order&fun=show_order&order_id=<?php echo $order_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
