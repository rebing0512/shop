...
<style type="text/css">
#box { background: #FFF; width: 238px; height: 410px; margin: -390px 0 0 0; display: block; border: solid 4px 02a129; position: absolute; z-index: 999; opacity: .5 }
...
<div id="page-more"><a href="index.php?con=promotion&gc_id=<?php echo $_GET['gc_id'];?>&curpage=2"></a></div>
