...
class accountControl extends SystemControl{
    private $links = array(
        array('url'=>'con=account&fun=qq','lang'=>'qqSettings'),
        array('url'=>'con=account&fun=sina','lang'=>'sinaSettings'),
        array('url'=>'con=account&fun=sms','text'=>'手机短信'),
        array('url'=>'con=account&fun=wx','text'=>'微信登录'),
		// array('url'=>'con=account&fun=uc','text'=>'UC互联')
    );
