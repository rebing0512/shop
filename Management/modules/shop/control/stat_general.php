...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_general&fun=general','lang'=>'stat_generalindex'),
        array('url'=>'con=stat_general&fun=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'con=stat_general&fun=orderprange','lang'=>'stat_orderpricerange')
    );
