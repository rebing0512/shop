...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?con=member_bind&fun=weixinunbind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?con=member_bind&fun=weixinunbind">
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="javascript:void(0);" onclick="ajax_form('weixin_form', '绑定微信账号', '<?php echo urlShop('connect_wx', 'index');?>', 360);"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/wx_bind_small.png"></a>
