...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-mint" href="index.php?con=member_security&fun=auth&type=pd_cash"><i class="icon-money"></i>申请提现</a>
  </div>
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      ...
      <input type="hidden" name="fun" value="pd_cash_list" />
      <tr>
      <th></th><td></td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="index.php?con=predeposit&fun=pd_cash_info&id=<?php echo $val['pdc_id']; ?>"><?php echo $lang['nc_view']; ?></a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
