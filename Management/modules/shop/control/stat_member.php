...
class stat_memberControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_member&fun=newmember','lang'=>'stat_newmember'),
        array('url'=>'con=stat_member&fun=analyze','lang'=>'stat_memberanalyze'),
        array('url'=>'con=stat_member&fun=scale','lang'=>'stat_scaleanalyze'),
        array('url'=>'con=stat_member&fun=area','lang'=>'stat_areaanalyze'),
        array('url'=>'con=stat_member&fun=buying','lang'=>'stat_buying'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['fun']) || in_array($_REQUEST['fun'],array('newmember','analyze','scale','area','buying','get_scale_xml'))){
    ...
    public function newmemberOp(){
        ...
        if($this->search_arr['search_type'] == 'day'){
            ...
            Tpl::output('actionurl','index.php?con=stat_member&fun=newmember&search_type=day&search_time='.date('Y-m-d',$this->search_arr['day']['search_time']));
        }
        ...
        if($this->search_arr['search_type'] == 'week'){
            ...
            Tpl::output('actionurl','index.php?con=stat_member&fun=newmember&search_type=week&searchweek_year='.$this->search_arr['week']['current_year'].'&searchweek_month='.$this->search_arr['week']['current_month'].'&searchweek_week='.$this->search_arr['week']['current_week']);
        }
        ...
        if($this->search_arr['search_type'] == 'month'){
            ...
            Tpl::output('actionurl','index.php?con=stat_member&fun=newmember&search_type=month&searchmonth_year='.$this->search_arr['month']['current_year'].'&searchmonth_month='.$this->search_arr['month']['current_month']);
        }
    ...
    public function showmemberOp(){
        ...
        $this->links[] = array('url'=>'con=stat_member&fun=showmember','lang'=>'stat_memberlist');
