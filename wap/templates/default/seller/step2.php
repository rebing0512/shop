  ...
  $(function(){
      ...
      $("#seller_name").keyup(function(){
         ...
         $.ajax({  
            ...
            url:'<?php echo urlMobile('store_joinin', 'check_seller_name_exist');?>',  
     ...
     $("#store_name").keyup(function(){
         ...
         $.ajax({  
            ...
            url:'<?php echo urlMobile('store_joinin', 'checkname');?>',  
      ...
      console.log(data);
       ...
       $.ajax({
        ...
        url: ApiUrl + "/index.php?con=store_joinin&fun=savestep1",
