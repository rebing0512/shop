...
<div class="ncm-flow-layout">
  <div id="ncmInformFlow" class="ncm-flow-container">
    ...
    <div class="ncm-default-form">
      <div id="warning"></div>
      <form id="add_form" enctype="multipart/form-data" method="post" action="index.php?con=member_inform&fun=inform_save">
...
function bindInformSubject(key) {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?con=member_inform&fun=get_subject_by_typeid',
        cache:false,
        data:'typeid='+type_id,
        dataType:'json',
