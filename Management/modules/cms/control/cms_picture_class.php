...
class cms_picture_classControl extends SystemControl{
    ...
    public function cms_picture_class_saveOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('class_add_success'),'index.php?con=cms_picture_class&fun=cms_picture_class_list');
        } else {
            $this->log(Language::get('cms_log_picture_class_save').$result, 0);
            showMessage(Language::get('class_add_fail'),'index.php?con=cms_picture_class&fun=cms_picture_class_list','','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_list'),'menu_url'=>'index.php?con=cms_picture_class&fun=cms_picture_class_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=cms_picture_class&fun=cms_picture_class_add'),
        );
