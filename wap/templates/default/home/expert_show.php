...
<header id="header" class="nctouch-product-header fixed">
    ...
    <div class="header-wrap">
        ...
        <div class="header-title">
            ...
            <h1><?php echo $output['detail']['name'];?></h1>
...
-->
                <div class='word'><?php echo htmlspecialchars_decode($output['detail']['detail']);?></div>
        ...
        <div class="com-area" id="PLmao">
            ...
            <span class="pl">
              ...
              <em>阅读 <?php echo $output['article']['article_view']?></em>
