...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=stat_member&fun=get_member_xml&t=<?php echo $_GET['t'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?con=stat_member&fun=showmember&exporttype=excel&t=<?php echo $_GET['t'];?>';
