...
class flea_goodsControl extends BaseHomeControl {
	...
	public function indexOp() {
		...
		if(!empty($_GET['succ'])){
			if($_GET['succ']=='succ'){
				$succ_link = 'location:index.php?con=flea_goods&goods_id='.$_GET['goods_id']."#flea_message";
				@header($succ_link);
			}
		}
		/**
	...
	public function save_consultOp(){
		...
		if($consult->addConsult($input)){
			...
			$succ_link = 'index.php?con=flea_goods&goods_id='.intval($_POST['goods_id']).'&succ=succ';
