    ...
    public function cms_article_list_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            $o .= '<li><a target="_blank" href="' .
                    CMS_SITE_URL .
                    '/index.php?con=article&fun=article_detail&article_id=' .
                    $val['article_id'] .
                    '">查看文章</a></li>';
...
EOB;
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_list'),'menu_url'=>'index.php?con=cms_article&fun=cms_article_list'),
            'list_verify'=>array('menu_type'=>'link','menu_name'=>Language::get('cms_article_list_verify'),'menu_url'=>'index.php?con=cms_article&fun=cms_article_list_verify'),
            'list_published'=>array('menu_type'=>'link','menu_name'=>Language::get('cms_article_list_published'),'menu_url'=>'index.php?con=cms_article&fun=cms_article_list_published'),
        );
