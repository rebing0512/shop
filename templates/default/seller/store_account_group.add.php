      ...
      <dd>
        ...
        <div class="ncsc-account-container">
          ...
          <ul class="ncsc-account-container-list">
            ...
            <li>
              <input id="<?php echo $submenu_value['con'];?>" class="checkbox" name="limits[]" value="<?php echo $submenu_value['con'];?>" <?php if(!empty($output['group_limits'])) {if(in_array($submenu_value['con'], $output['group_limits'])) { echo 'checked'; }}?> type="checkbox" />
              <label for="<?php echo $submenu_value['con'];?>"><?php echo $submenu_value['name'];?></label>
            </li>
            <?php } ?>
          </ul>
          <?php } ?>
