...
class store_mapControl extends BaseSellerControl
{
    ...
    public function indexOp()
    {
        ...
        if (chksubmit()) {
            ...
            if (!empty($map_list)) {
                ...
                $map_array['store_id'] = $_SESSION['store_id'];
    ...
    private function profile_menu($menu_type, $menu_key = '')
    {
        ...
        switch ($menu_type) {
            case 'store_map':
                $menu_array = array(
                    array('menu_key' => 'index', 'menu_name' => '地图显示 ', 'menu_url' => 'index.php?con=store_map&fun=index'),
                    array('menu_key' => 'list', 'menu_name' => '列表显示 ', 'menu_url' => 'index.php?con=store_map&fun=list')
                );
                break;
        }
