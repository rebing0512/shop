...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="fun" value="hotrank" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?con=stat_store&fun=hotrank_list&type='+type+'&search_sclass='+search_sclass+'&t=<?php echo $output['searchtime'];?>');
}
</script>