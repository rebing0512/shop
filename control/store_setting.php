...
class store_settingControl extends BaseSellerControl {
    ...
    public function store_settingOp(){
        ...
        if (chksubmit()){
            ...
            $param = array(
                ...
                'recommend_pic' => empty($_POST['recommend_pic']) ? $store_info['recommend_pic'] : $_POST['recommend_pic'],
            ...
            $model_class->editStore($param, array('store_id' => $store_id));
            showDialog(Language::get('nc_common_save_succ'),'index.php?con=store_setting&fun=store_setting','succ');
        }
        /**
         * 实例化店铺等级模型
         */
        ...
        $store_info['recommend'] = Model('index_recommend_store')->where('store_id='.$_SESSION['store_id'])->find();
        /**
         * 输出店铺信息
         */
    ...
    public function store_slideOp() {
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            $update['store_slide_title']  = implode(',', $_POST['title']);
            ...
            showDialog(Language::get('nc_common_save_succ'),'index.php?con=store_setting&fun=store_slide','succ');
        }
        ...
        if ($store_info['store_type']<4){
            showDialog('尚未获得高级店铺权限。', urlShop('store_setting', 'store_setting'), '', '' );
        }
        if ($store_info['store_type']>=4&&empty($store_info['store_decoration_switch'])){
            showDialog('尚未开启店铺装修,请到店铺装修中开启。', urlShop('store_setting', 'store_setting'), '', '' );
        }
    ...
    public function themeOp(){
         ...
         */
        $style_data = array();
        $style_configurl = BASE_ROOT_PATH.DS.'/templates/'.TPL_SHOP_NAME.DS.'store'.DS.'style'.DS."styleconfig.php";
    ...
    public function store_mobileOp()
    {
        ...
        if (chksubmit()) {
            ...
            showDialog('保存成功', 'index.php?con=store_setting&fun=store_mobile', 'succ');
        }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            1=>array('menu_key'=>'store_setting','menu_name'=>Language::get('nc_member_path_store_config'),'menu_url'=>'index.php?con=store_setting&fun=store_setting'),
            4=>array('menu_key'=>'store_slide','menu_name'=>'首页广告设置','menu_url'=>'index.php?con=store_setting&fun=store_slide'),
            //5=>array('menu_key'=>'store_theme','menu_name'=>'店铺主题','menu_url'=>'index.php?con=store_setting&fun=theme'),

            // 7 => array(
            //     'menu_key' => 'store_mobile',
            //     'menu_name' => '手机店铺设置',
            //     'menu_url' => 'index.php?con=store_setting&fun=store_mobile',
            // ),
        );
