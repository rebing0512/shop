...
class member_refundControl extends mobileMemberControl {
    ...
    *退款退货详情
    */
    public function member_refund_infoOp() {
         Tpl::output('web_seo',C('site_name').' - '.'退款详情');
         Tpl::showpage('member_refund_info');
    }
    /*
    *退款退货详情
    */
    public function refund_allOp() {
         Tpl::output('web_seo',C('site_name').' - '.'订单退款');
         Tpl::showpage('refund_all');
    }
    /*
    *退款退货详情
    */
    public function refundOp() {
         Tpl::output('web_seo',C('site_name').' - '.'商品退款');
         Tpl::showpage('refund');
    }
    /*
    *商品退货
    */
    public function returnOp(){
         Tpl::output('web_seo',C('site_name').' - '.'商品退货');
         Tpl::showpage('return');
    }
