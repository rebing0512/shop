...
<div class="wrap">
  <div class="tabmenu">
    ...
    <div class="ncm-default-form">
      <form method="post" id="profile_form" action="<?php echo SHOP_SITE_URL;?>/index.php?con=member_information&fun=member">
        ...
        <dl>
          ...
          <dd><span class="w400"><?php echo $output['member_info']['member_email']; ?>&nbsp;&nbsp;
            <a href="index.php?con=member_security&fun=auth&type=modify_email">
