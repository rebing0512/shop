...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=member&fun=get_xml',
        colModel : [
            ...
            {display: 'VIP', name : 'vip', width : 150, sortable : true, align: 'left'},
            {display: '会员邮箱', name : 'member_email', width : 150, sortable : true, align: 'left'},
            {display: '登录手机', name : 'login_mobile', width : 80, sortable : true, align: 'center'},
...
//            {display: '<i class="fa fa-plus"></i>新增数据', name : 'add', bclass : 'add', title : '新增数据', onpress : fg_operation },
        ...
        searchitems : [
            ...
            {display: '会员手机', name : 'login_mobile'}
            ],
        sortname: "member_id",
        sortorder: "desc",
        title: '商城会员列表'
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=member&fun=member_add';
    }
    if (name == 'csv') {
