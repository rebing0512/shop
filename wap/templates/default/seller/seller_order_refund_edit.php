...
<form id="post_form" method="post" action="<?php echo urlMobile('seller_order_refund','edit',array('refund_id'=>$output['refund']['refund_id']));?>">
<input type="hidden" name="form_submit" value="ok" />
<div class="alert">
    <h4>注意事项：</h4>
    只能提交一次，请认真选择。同意并经过平台确认后会将金额以预存款的形式返还给买家。不同意时买家可以向平台投诉或再次申请。
</div>
  	<ul class="nctouch-default-list">
	  <li>
	    <h4>是否同意</h4>
