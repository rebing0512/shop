...
<div class="page">
  ...
  <form id="article_form" enctype="multipart/form-data" method="post" name="articleForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row" nctype="article_position" style="display: none">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value="" name="article_author" id="article_author" class="input-txt">
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
...
<!-- ================================================================ -->
      <dl class="row" id="adv_pic">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">系统支持的图片格式为:gif,jpg,jpeg,png(图片尺寸640*412)</p>
        </dd>
      </dl>
<!-- ================================================================ -->
       <dl class="row">
        ...
        <dd class="opt">
          <textarea type="text"  name="article_summary" id="article_summary" class="tarea"></textarea>
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo mt_rand(5, 25);?>" name="article_view" id="article_view" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">评论人数</dt>
        <dd class="opt">
          <input type="text" value="<?php echo mt_rand(1, 8);?>" name="article_zan" id="article_zan" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
       <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="" name="article_time" id="article_time" class="txt" >
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
       <dt class="tit">小编推荐商品(填写id)</dt>
        <dd class="opt">
         <input type="text" value="" name="article_goods_id" id="goods_id" class="input-txt">
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?con=article&fun=article_pic_upload',
