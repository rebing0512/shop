    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><a href="index.php?con=cms_special&fun=cms_special_drop&special_id=<?php echo $val['special_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a> <span class="btn"><em><i class="fa fa-cog"></i><?php echo $lang['nc_set'];?><i class="arrow"></i></em>
            <ul>
              <li>
                <?php if($val['special_state'] == '2') { ?>
                <a href="<?php echo $val['special_link'];?>" target="_blank">查看专题页面</a>
                <?php } else { ?>
                <a href="index.php?con=cms_special&fun=cms_special_detail&special_id=<?php echo $val['special_id'];?>" target="_blank">预览专题页面</a>
                <?php } ?>
              </li>
              <li><a href="index.php?con=cms_special&fun=cms_special_edit&special_id=<?php echo $val['special_id'];?>">编辑专题内容</a></li>
            </ul>
            </span></td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=cms_special&fun=cms_special_add';
    }
}
</script>