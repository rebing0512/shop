...
class navigationControl extends SystemControl{
            ...
            foreach ($navigation_list as $k => $v){
                switch ($v['nav_location']){
                    ...
                    case '2':
                        ...
                        break;
                    case '3':
                        $navigation_list[$k]['nav_location'] = $lang['navigation_index_cmscenter'];
                        break;
                }
            }
        }
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?con=navigation&fun=navigation_add',
                            'msg'=>$lang['navigation_add_again'],
                        ),
                        array(
                            'url'=>'index.php?con=navigation&fun=navigation',
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?con=navigation&fun=navigation_edit&nav_id='.intval($_POST['nav_id']),
    ...
    public function navigation_delOp(){
        ...
        if (preg_match('/^[\d,]+$/', $_GET['nav_id'])) {
            ...
            showMessage($lang['navigation_index_del_succ'],'index.php?con=navigation&fun=navigation');
        }else {
            showMessage($lang['navigation_index_choose_del'],'index.php?con=navigation&fun=navigation');
        }
    }
