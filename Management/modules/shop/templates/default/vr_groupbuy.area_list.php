...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?con=vr_groupbuy&fun=class_list">分类管理</a></li>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>商家发布虚拟商品的特卖时，需要选择虚拟特卖所属区域</li>
      <li>显示一级城市名称，可以编辑、删除一级城市，点击查看区域，可以查看该城市下区域列表</li>
      <li>可以按照区域名称、首字母进行查询</li>
    </ul>
  </div>

  <form id="list_form" method="post" action="index.php?con=vr_groupbuy&fun=area_drop">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=vr_groupbuy&fun=area_list_xml',
        colModel: [
