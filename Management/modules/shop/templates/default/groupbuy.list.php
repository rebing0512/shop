...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>管理员可以审核新的特卖活动申请、取消进行中的特卖活动或者删除特卖活动</li>
    </ul>
  </div>
        ...
        <div id="searchCon" class="content">
          <div class="layout-box">
            <dl>
              <dt>特卖名称</dt>
              <dd>
                <input type="text" name="groupbuy_name" class="s-input-txt" placeholder="请输入特卖名称关键字" />
              </dd>
            </dl>
            <dl>
              <dt>商品名称</dt>
...
<script>
$(function(){
    var flexUrl = 'index.php?con=groupbuy&fun=groupbuy_list_xml';

    $("#flexigrid").flexigrid({
        url: flexUrl,
        colModel: [
            {display: '操作', name: 'operation', width: 150, sortable: false, align: 'center', className: 'handle'},
            {display: '特卖类型', name: 'is_vr', width: 60, sortable: false, align: 'left'},
            {display: '特卖名称', name: 'groupbuy_name', width: 400, sortable: false, align: 'left'},
            ...
            {display: '特卖图片', name: 'groupbuy_image', width: 60, sortable: false, align: 'center'},
            ...
            {display: '特卖状态', name: 'groupbuy_state_text', width: 80, sortable: false, align: 'center'}
        ],
        searchitems: [
            {display: '特卖名称', name: 'groupbuy_name', isdefault: true},
