  ...
  <div class="clear"></div>
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        <div class="avatar"><a href="<?php echo urlShop('member_information', 'avatar');?>" title="修改头像"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']);?>">
          <div class="frame"></div>
          </a>
          <?php if (intval($output['message_num']) > 0){ ?>
          <a href="<?php echo SHOP_SITE_URL?>/index.php?con=member_message&fun=message" class="new-message" title="新消息"><?php echo intval($output['message_num']); ?></a>
          <?php }?>
        </div>
        <dl>
          <dt><a href="<?php echo urlShop('member_information', 'member');?>" title="修改资料"><?php echo $output['member_info']['member_name'];?></a></dt>
          <dd>会员等级：
          ...
          <dd>账户安全：
            <div class="SAM"><a href="<?php echo urlShop('member_security','index');?>" title="安全设置">
          ...
          <dd>用户财产：
            <div class="user-account">
              <ul>
                <li id="pre-deposit"><a href="<?php echo urlShop('predeposit', 'pd_log_list');?>" title="我的余额：￥<?php echo $output['member_info']['available_predeposit'];?>"> <span class="icon"></span> </a> </li>
                <li id="points"><a href="<?php echo urlShop('member_points', 'index');?>" title="我的积分：<?php echo $output['member_info']['member_points'];?>分"> <span class="icon"></span></a> </li>
                <li id="voucher"><a href="<?php echo urlShop('member_voucher', 'index');?>" title="我的代金券：<?php echo $output['member_info']['voucher_count'];?>张"> <span class="icon"></span></a> </li>
                <!-- <li id="envelope"><a href="<?php echo urlShop('member_redpacket', 'index');?>" title="我的红包：<?php echo $output['member_info']['redpacket_count'];?>张"> <span class="icon"></span></a></li> -->
              </ul>
            </div>
          </dd>
        </dl>
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        ...
        <li class="set"><a href="<?php echo urlShop('member', 'home');?>">用户设置<i></i></a>
          <div class="sub-menu">
            <dl>
              <dt><a href="<?php echo urlShop('member_security', 'index');?>" style="color: #3AAC8A;">安全设置</a></dt>
              <dd><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_pwd'));?>">修改登录密码</a></dd>
              ...
              <dd><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_paypwd'));?>">支付密码</a></dd>
            </dl>
            <dl>
              <dt><a href="<?php echo urlShop('member_information', 'member')?>" style="color: #EA746B">个人资料</a></dt>
              <dd><a href="<?php echo urlShop('member_address', 'address');?>">收货地址</a></dd>
              <dd><a href="<?php echo urlShop('member_information', 'avatar')?>">修改头像</a></dd>
              <dd><a href="<?php echo urlShop('member_message', 'setting');?>">消息接受设置</a></dd>
            </dl>
            <dl>
              <dt><a href="<?php echo urlShop('predeposit', 'pd_log_list')?>" style="color: #FF7F00">账户财产</a></dt>
              <dd><a href="<?php echo urlShop('predeposit', 'recharge_add');?>">余额充值</a></dd>
              <dd><a href="<?php echo urlShop('member_voucher', 'voucher_binding')?>">领取代金券</a></dd>
              <!-- <dd><a href="<?php echo urlShop('member_redpacket', 'rp_binding');?>">领取红包</a></dd> -->
            </dl>
            <dl>
              <dt><a href="<?php echo urlShop('member_bind', 'qqbind')?>" style="color: #398EE8">账号绑定</a></dt>
              <dd><a href="<?php echo urlShop('member_bind', 'qqbind');?>">QQ绑定</a></dd>
              <dd><a href="<?php echo urlShop('member_bind', 'sinabind')?>">微博绑定</a></dd>
              <!-- <dd><a href="<?php echo urlShop('member_bind', 'weixinbind');?>">微信绑定</a></dd> -->
              <dd><a href="<?php echo urlShop('member_sharemanage', 'index');?>">分享绑定</a></dd>
            </dl>
          </div>
        </li>
