...
<dl>
  <dt><span class="thumb"><a href="javascript:void(0)" > <img src="<?php echo getMemberAvatar($value['member_avatar']);?>" alt="<?php echo $value['member_name'];?>"/></a></span></dt>
  <dd>
    <p class="comment-user"><a href="javascript:void(0)" > <?php echo $value['member_name'];?></a><em>发表于<?php echo date('Y-m-d H:i:s',$value['comment_time']);?></em>
    </p>
