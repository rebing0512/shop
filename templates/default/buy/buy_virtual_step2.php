    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr class="shop-list">
          ...
          <td><em id="item_price" class="goods-price"><?php echo $output['goods_info']['goods_price'];?></em><!-- S 商品促销-特卖 -->
      ...
      <tfoot>
        <tr>
          <td colspan="20"><a href="index.php?con=buy_virtual&fun=buy_step1&goods_id=<?php echo $_POST['goods_id'];?>&quantity=<?php echo $_POST['quantity'];?>" class="ncc-prev-btn"><i class="icon-angle-left"></i>返回上一步</a><div class="ncc-all-account">订单总金额：<em id="orderTotal"><?php echo $output['goods_info']['goods_total']; ?></em>元</div><a id="submitOrder" href="javascript:void(0)" class="ncc-next-submit ok">提交订单</a></td>
        </tr>
      </tfoot>
    </table>
  </div>
