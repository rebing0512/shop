...
//define('ATTACH_ARTICLE_LIST','shop/article/store');
//define('ATTACH_ARTICLE_ALBUM','shop/article/album');
//define('ATTACH_ARTICLE_LOGO','shop/article/logo');
//define('ATTACH_BRAND','shop/brand');
//define('ATTACH_BRAND_BIG','shop/brand/big');
...
// * 商品图片
// */
//define('ALBUM_IMAGES_WIDTH', '60,240,_360,_1280');
//define('ALBUM_IMAGES_HEIGHT', '60,240,_360,_1280');
//define('ALBUM_IMAGES_EXT', '_60,_240,_360,_1280');
///**
// *  订单状态
// */
////已取消
...
//define('LOGIN_SITE_URL',$config['shop_site_url']);
//define('BASE_DATA_PATH',BASE_ROOT_PATH.'/data');
...
//}
//
//require_once(BASE_CORE_PATH.'/framework/libraries/queue.php');//队列
//require_once(BASE_CORE_PATH.'/framework/function/core.php');//基础方法
