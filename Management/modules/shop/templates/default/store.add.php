...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=store&fun=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value="1000" id="store_sort" name="store_sort" class="input-txt"/>
                <span class="err"></span>
                <p class="notic">数字越小，排序靠前，默认为1000</p>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
            ...
            <dd class="opt">
                <input type="text" value="" id="businesscard_id" name="businesscard_id" class="input-txt">
                <span class="err"></span>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <label>
                    <input type="radio" checked="checked" value="0" name="store_type">
                    新秀</label>
                <label>
                    <input type="radio" value="1" name="store_type">
                    大师</label>
                <span class="err"></span>
                <p class="notic">默认为新秀</p>
            </dd>
        </dl>
      <dl class="row">
        <dt class="tit">
    ...
    $('#store_form').validate({
        ...
        rules : {
            ...
            member_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?con=ownshop&fun=check_member_name',
                    type: 'get',
                    data:{
            ...
            seller_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?con=ownshop&fun=check_seller_name',
                    type: 'get',
                    data:{
