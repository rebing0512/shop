...
Tpl::showpage('circle_theme.list');
    ...
    public function get_xmlOp() {
        ...
        foreach ($theme_list as $value) {
            ...
            $operation .= "<li><a href='index.php?con=circle_theme&fun=theme_info&t_id=".$value['theme_id']."'>查看话题内容</a></li>";
            $operation .= "<li><a href='index.php?con=circle_theme&fun=theme_reply&t_id=".$value['theme_id']."'>查看话题回复</a></li>";
...
Tpl::showpage('circle_theme.info');
    ...
    public function theme_delOp(){
        ...
        showMessage(L('nc_common_op_succ'), 'index.php?con=circle_theme&fun=theme_list');
    }
    /**
     * 话题回复
     */
