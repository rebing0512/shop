...
<div class="alert alert-block hr32">
  ...
  <ul class="ml30">
    <li>1. <?php echo $lang['store_goods_step3_continue'];?> &quot; <a href="<?php echo urlShop('store_goods_add', 'add_step_two');?>"><?php echo $lang['store_goods_step3_release_new_goods'];?></a>&quot;</li>
