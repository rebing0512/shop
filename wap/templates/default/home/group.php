...
<div style="margin-top:47px;margin-bottom: 50px" class="main">
    <div  class="mb_activity_list">
        <img style="width: 98%;" border="0" src="<?php echo MOBILE_TEMPLATES_URL;?>/images/group.jpg">
    </div>
    <p>长按关注"专家鉴定团"</p>
    <div style="background-color: white;color: black;font-size: .8rem;">
        <a href="tel:0591-83788999">
            <p class="dlp"><i class="phone"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/images/phone.png"></i><span style="left: 0;">专家鉴定团电话</span><span style="position: absolute;right: 0;padding-right: 10px;color: #8e8e8e;">177-5026-6780</span></p>
        </a>
    </div>
</div>
