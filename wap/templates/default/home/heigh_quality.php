...
<header id="header" class="transparent"
    ...
    <div class="header-wrap asd nav_body" style="position:relative;height:2.35rem;">
        ...
        <ul style="margin-left: 3vw;">
            ...
            <?php if ($output['platform']=='ios' || in_array(C('app_alias'), ['guoshizhijia', 'zhile'])): ?>
                ...
                <a href="javascript:;" onclick="window.MBC.to_shop_index(ApiUrl)">
                    <li>商城</li>
                </a><i>|</i>
    ...
    <div class="swiper-wrapper">
        <?php if (C('app_alias') == 'guoshizhijia'): ?>
            <div class="swiper-slide">
                <a href="javascript:;"
                   onclick="window.MBC.openNew({pageTitle:'店铺街',url:'https://guoshizhijiashop.confolsc.com/wap/index.php?con=shop&fun=store_street',removeHeader:false})">
                    <img style="width:100%;"
                         src="<?php echo RESOURCE_SITE_URL; ?>/images/index_icon/shangcheng.jpg">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="javascript:;"
                   onclick="window.MBC.openNew({pageTitle:'随手拍',url:'https://guoshizhijiapaimai.confolsc.com/',removeHeader:false})">
                    <img style="width:100%;"
                         src="<?php echo RESOURCE_SITE_URL; ?>/images/index_icon/paimai.jpg">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="javascript:;"
                   onclick="window.MBC.openNew({pageTitle:'掌眼',url:'https://guoshizhijiabbs.confolsc.com/zhang_eye',removeHeader:false})">
                    <img style="width:100%;"
                         src="<?php echo RESOURCE_SITE_URL; ?>/images/index_icon/jiandingshi.jpg">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="javascript:;"
                   onclick="window.MBC.openNew({pageTitle:'附近的店',url:'https://guoshizhijiabbs.confolsc.com/circum',removeHeader:false})">
                    <img style="width:100%;"
                         src="<?php echo RESOURCE_SITE_URL; ?>/images/index_icon/fujindian.jpg">
                </a>
            </div>
...
<!--            --><?php //endforeach; ?>
            <div class="swiper-slide">
                <a href="javascript:;">
                    <img style="width:100%;" src="<?php echo RESOURCE_SITE_URL; ?>/images/index_icon/2018032901.jpg" />
                </a>
            </div>
        <?php endif; ?>
    </div>
...
<div class="list_content">
    <ul class="clearfix">
        <?php foreach ((array)$output['core_category']['result']['category'] as $cate): ?>
            ...
            <li>
                <a href="<?php echo urlMobile('goods', 'supermarket', array('__ccid' => $cate['id'])); ?>" class="yuan">
...
//                    });
        ...
        var loadMarketData = function () {
            ...
            loading = true;
            $.ajax({
                url: '/wap/index.php?con=goods&fun=quality_api&curpage=' + curpage,
                dataType: 'json',
...
<?php if (!in_array($output['client'], ['ios', 'android'])): ?>
    <div id="fullshare" style="position: fixed;width:1.8rem;height:1.8rem;bottom:3.1rem;right:0.8rem;z-index: 999" data-id="0" onclick="fullshare()"> <i></i></div>
<!--    <div-->
<!--        class="yimeng_camera" style="position: fixed;right: 0.8rem;bottom:3.1rem;width:1.8rem;z-index: 5;"-->
<!--        onclick="yimeng_camera()"><i></i>-->
<!--    </div>-->
    <div class="fix-block-r" style="bottom: 5.5rem;">
...
<!--        </div>-->
    ...
    <?php if (in_array($output['client'], ['android'])): ?>
        <div id="fullshare" style="position: fixed;width:1.8rem;height:1.8rem;bottom:0.6rem;right:0.8rem;z-index: 999" data-id="0" onclick="fullshare()"> <i></i></div>
<!--        <div-->
<!--            class="yimeng_camera" style="position: fixed;right: 0.8rem;bottom:0.6rem;width:1.8rem;z-index: 5;"-->
<!--            onclick="yimeng_camera()"><i></i>-->
<!--        </div>-->
        <div class="fix-block-r" style="bottom: 3rem;">
            <a href="javascript:void(0);" class="gotop-btn gotop hide" onclick="goTopBtn()" id="goTopBtn"><i></i></a>
        </div>
    <?php endif; ?>
<?php endif; ?>
...
<script>
    ...
    function fullshare() {
        var scfg = {
            title: '<?=$output['share_info'][C('app_alias')]['jp']['name']?>',
            description: '<?=$output['share_info'][C('app_alias')]['jp']['desc']?>',
            image: '<?=$output['share_info'][C('app_alias')]['jp']['image']?>',
