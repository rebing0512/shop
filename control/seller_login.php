...
class seller_loginControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        if (!empty($_SESSION['seller_id'])) {
            @header('location: index.php?con=seller_center');die;
        }
    }
    ...
    public function loginOp() {
        ...
        ##array('seller_login_mobile' => $_POST['seller_name'])
        $username = addslashes($_POST['seller_name']);
        $seller_info = $model_seller->getSellerInfo("seller_login_mobile = '{$username}' or seller_name = '{$username}'");
        if($seller_info) {
            ...
            if($member_info) {
                ...
                redirect('index.php?con=seller_center');
            } else {
