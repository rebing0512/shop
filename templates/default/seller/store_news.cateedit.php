...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php echo urlShop('store_news', 'news_cateupdate');?>">
   <input name="id" type="hidden" class="text w400" value="<?php echo $output['data']['id'];?>" />
    <div class="ncsc-form-goods">
      ...
      <dl>
        ...
        <dd>
          <input name="cate_name" type="text" class="text w400" value="<?php echo $output['data']['cate_name'];?>" />
          <span></span>
      ...
      <dl>
        ...
        <dd>
          <input name="cate_jump" type="text" class="text w400" value="<?php echo $output['data']['cate_name'];?>" />
          <span></span>
      ...
      <dl>
        ...
        <dd>
          <input name="cate_sort" type="text" class="text w400" value="<?php echo $output['data']['cate_sort'];?>" />
          <span></span>
      ...
      <dl>
        ...
        <dd>
          <input name="cate_display" type="radio"  value="0" <?php if($output['data']['cate_display'] == 0){?> checked="true" <?php }?>/>开启
          <input name="cate_display" type="radio"  value="1"  <?php if($output['data']['cate_display'] == 1){?> checked="true" <?php }?> />关闭
          <span></span>
