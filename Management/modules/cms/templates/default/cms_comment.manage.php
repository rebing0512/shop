...
<script>
$(function(){
    var flexUrl = 'index.php?con=cms_comment&fun=comment_manage_xml';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?con=cms_comment&fun=comment_drop&comment_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
