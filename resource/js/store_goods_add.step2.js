$(function(){
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?con=store_goods_add&fun=image_upload&upload_type=uploadedfile',
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: SITEURL+'/index.php?con=store_goods_add&fun=image_upload',
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?con=store_album&fun=pic_list&item=mobile');
    });
    // 关闭 图片选择
    ...
    $('div[nctype="mobile_pannel"]').on('click', 'a[nctype="mp_rpl"]', function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?con=store_album&fun=pic_list&item=mobile&type=replace');
    });
    // 插图图片
