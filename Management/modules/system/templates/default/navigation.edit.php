...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=navigation&fun=navigation" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <label for="nav_location3"><?php echo $lang['navigation_index_cmscenter'];?> </label>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
