...
<div class="goods-gallery"> <a class='sample_demo' id="select_s" href="index.php?con=flea_album&fun=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
  <ul class="list">
