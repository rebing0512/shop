...
Tpl::showpage('cms_navigation.add');
    ...
    public function cms_navigation_saveOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('navigation_add_success'),'index.php?con=cms_navigation&fun=cms_navigation_list');
        } else {
            $this->log(Language::get('cms_log_navigation_save').$result, 0);
            showMessage(Language::get('navigation_add_fail'),'index.php?con=cms_navigation&fun=cms_navigation_list','','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_list'),'menu_url'=>'index.php?con=cms_navigation&fun=cms_navigation_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=cms_navigation&fun=cms_navigation_add'),
        );
