...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="con" value="store_order" />
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['store_order_order_sn'].$lang['nc_colon'];?><em><?php echo $order['order_sn']; ?></em>
        ...
        <span>取货方式：门店自提</span>
        <?php } ?>
        <span class="fr mr5"> <a href="index.php?con=store_order&fun=order_print&order_id=<?php echo $order_id;?>" class="ncbtn-mini" target="_blank" title="打印发货单"/><i class="icon-print"></i>打印发货单</a></span> </th>
    </tr>
    <?php $i = 0;?>
