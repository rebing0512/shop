...
<div class="ncm-container">
  ...
  <div class="clear"></div>
    <div class="ncm-header-top">
      <div class="ncm-member-info ncm-member-info1">
        ...
        <dl>
          ...
          <dd>登录绑定：
            <div class="user-account">
              <ul>
                <li id="qq"><a href="<?php echo urlShop('member_bind', 'qqbind');?>" title="登录绑定QQ账号" <?php if (!empty($output['member_info']['member_qqopenid'])){?>class="have"<?php }?>> <span class="icon"></span> </a> </li>
                <li id="weichat"><a href="<?php echo urlShop('member_bind', 'weixinbind');?>" title="登录绑定微信账号" <?php if (!empty($output['member_info']['weixin_unionid'])){?>class="have"<?php }?>> <span class="icon"></span></a> </li>                 <li id="weibo"><a href="<?php echo urlShop('member_bind', 'sinabind');?>" title="登录绑定微博账号" <?php if (!empty($output['member_info']['member_sinaopenid'])){?>class="have"<?php }?>> <span class="icon"></span></a> </li>
              </ul>
            </div>
          </dd>
        </dl>
      ...
      <div class="ncm-set-menu">
        <dl class="zhaq">
          ...
          <dd>
            <ul>
              <li><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_pwd'));?>"><span class="zhaq01"></span><sub></sub>
                <h5>修改密码</h5>
                </a> </li>
              <li <?php if($output['member_info']['member_email_bind'] == '1') {?>class="have"<?php }?>><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_email'));?>"><span class="zhaq02"></span><sub></sub>
                <h5>邮箱绑定</h5>
                </a> </li>
              <li <?php if($output['member_info']['member_mobile_bind'] == '1') {?>class="have"<?php }?>><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_mobile'));?>"><span class="zhaq03"></span><sub></sub>
                <h5>手机绑定</h5>
                </a> </li>
              <li <?php if($output['member_info']['member_paypwd'] != '') {?>class="have"<?php }?>><a href="<?php echo urlShop('member_security', 'auth', array('type' => 'modify_paypwd'));?>"><span class="zhaq04"></span><sub></sub>
                <h5>支付密码</h5>
                </a> </li>
            </ul>
          </dd>
        ...
        <dl class="zhcc">
          ...
          <dd>
            <ul>
              <li><a href="<?php echo urlShop('predeposit', 'recharge_add');?>"> <span class="zhcc01"></span>
                <h5>在线充值</h5>
                </a> </li>
              <li><a href="<?php echo urlShop('predeposit', 'rechargecard_add');?>"> <span class="zhcc02"></span>
                <h5>充值卡充值</h5>
                </a> </li>
              <li><a href="<?php echo urlShop('member_voucher', 'voucher_binding')?>"><span class="zhcc03"></span>
                <h5>领取代金券</h5>
                </a> </li>
            <!--   <li><a href="<?php echo urlShop('member_redpacket', 'rp_binding');?>"> <span class="zhcc04"></span>
                <h5>领取红包</h5>
                </a> </li> -->
            </ul>
          </dd>
        ...
        <dl class="xgsz">
          ...
          <dd>
            <ul class="trade-function-03">
              <li><a href="<?php echo urlShop('member_address', 'address');?>"><span class="xgsz01"></span>
                <h5>收货地址</h5>
                </a> </li>
              <li><a href="<?php echo urlShop('member_message', 'setting');?>"><span class="xgsz02"></span>
                <h5>消息接收</h5>
                </a> </li>
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        ...
        <li><a href="<?php echo urlShop('member', 'home');?>" class="current">用户设置</a> </li>
