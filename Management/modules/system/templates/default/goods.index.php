...
function fg_pinglun(gids) {
    _uri = "index.php?con=goods&fun=add&goods_id=" + gids;
    CUR_DIALOG = ajax_form('goods_pinlun', '为此商品添加评论', _uri, 640);
}

function fg_sku(commonid) {
    CUR_DIALOG = ajax_form('login','商品"' + commonid +'"的SKU列表','index.php?con=goods&fun=get_goods_sku_list&commonid=' + commonid, 580);
}
// 删除
function fg_del(id) {
