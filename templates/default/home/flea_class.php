...
<div class="content" style=" margin-top:10px;">
  <!--检索表单	-->
	<form id="condition" method="GET" action="index.php">
		<input type="hidden" name="con" value="flea_class" />
      ...
      <div class="fill_filter">
        ...
        <div class="tips orange">  
			<span class="tips_c">
				...
				<a class="ico3" style="text-decoration:underline; cursor:pointer;" nc_type="dialog" dialog_id="friend_add" dialog_title="<?php echo $lang['flea_oldnew_choose'];?>" uri="index.php?con=flea_class&fun=quality_inner" dialog_width="400">
        ...
        <li class=" seller_goods fn-left">
          <p class="pic fn-left">
             <span class="thumb size120">
               <i></i>
               <a class="user" href="index.php?con=flea_goods&goods_id=<?php echo $val['goods_id'];?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?UPLOAD_SITE_URL.DS.ATTACH_MALBUM.'/'.$val['member_id'].'/'.$val['goods_image']:SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>"/></a>                
             </span>
          </p>
          <div class="list fn-left">
            <h2>
				<a class="blue" href="index.php?con=flea_goods&goods_id=<?php echo $val['goods_id'];?>" title="<?php echo $val['goods_name'];?>">
          ...
          <div class="seller fn-left">
            <div class="pic fn-left">
              <span class="thumb size50">
                <i></i>
                <a href="index.php?con=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>&pic_input=1"><img src="<?php echo getMemberAvatar($_SESSION['avatar']);?>" width="50px" height="50px"/></a>
              </span>
            </div>
            <p class="seller_name">
				<a class="blue" href="index.php?con=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>">
            ...
            <div class="seller_num">
				...
				<a href="index.php?con=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>" class="orange">
  ...
  <div class="size200 fn-right">
    <a class="sell_btn2" href="index.php?con=member_flea&fun=add_goods"></a>
    <div class="sell_now">
      <h2 class="sell_title">
        <span></span>
      </h2>
					...
					<li class="sell_one">
					  <div>
						<p class="pic1">
						  ...
						  <i></i>
						  <a href="index.php?con=flea_class&seller_input=<?php echo $val['member_id'];?>">
								<img src="<?php echo getMemberAvatar($_SESSION['avatar']);?>" width="25px" height="25px"/>
							</a>              
						  </span>
						</p>
						<span class="user_name fn-left">
							<a class="blue2" href="index.php?con=flea_class&seller_input=<?php echo $val['member_id'];?>">
					  ...
					  <p class="items_title">
						<a href="index.php?con=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
