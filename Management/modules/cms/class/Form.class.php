...
class Form {
   ...
   /**
    ...
    $str = '<textarea id="'. $id .'" name="'. $id .'" style="width:'. $width .';height:'. $height .';'. $style .'">'.$value.'</textarea>';
  $str.= '
...
<script>
  ...
  KindEditor.ready(function(K) {
     ...
     */
    public static function date($name, $value = '', $format = 'YYYY/MM/DD hh:mm:ss') {
        ...
        $str = '';
        $str .= '<input type="text" name="' . $name . '" id="' . $id . '" value="' . $value . '"  onclick="laydate({istime: true, format:\''.$format.'\'})">';
        return $str;
    }
