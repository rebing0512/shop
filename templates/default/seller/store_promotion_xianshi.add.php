...
<div class="ncsc-form-default">
    ...
    <form id="add_form" action="index.php?con=store_promotion_xianshi&fun=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?con=store_promotion_xianshi&fun=xianshi_edit_save" method="post">
