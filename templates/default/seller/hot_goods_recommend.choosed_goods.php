...
<div class="eject_con">
    ...
    <?php if ($output['error'] == '') {?>
        <form id="choosed_goods_form" action="<?php echo urlShop('hot_goods_recommend', 'choosed_goods');?>" method="post" >
...
<!--            </dl>-->
            <dl>
                <dt>商品排序：</dt>
                <dd>
                    <input name="g_sort" type="text" class="text w100" value="" >
                    <p class="hint">请填写255以内的数字。</p>
                </dd>
            </dl>
            <div class="eject_con">
                <div class="bottom">
...
<script>
    $(function(){
        ...
        },'<i class="icon-exclamation-sign"></i>请填写255以内的数字');
        // 页面输入内容验证
...
//                }
                g_sort: {
                    required : "<i class='icon-exclamation-sign'></i>请填写推荐排序",
                    range : "<i class='icon-exclamation-sign'></i>请填写255以内的数字"
                }
            }
        });
    });
