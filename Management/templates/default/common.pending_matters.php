...
<ul class="cp-toast-list">
  ...
  <li>
    <span>[商城-促销]</span>
    <a target="workspace" href="javascript:void(0);" onclick="openItem('shop|groupbuy')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['groupbuy_verify'];?></strong>个特卖申请需要审核。</a>
  </li>
  <?php }?>
