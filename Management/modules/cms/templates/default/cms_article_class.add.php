...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=cms_article_class&fun=cms_article_class_list" title="返回文章分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" action="index.php?con=cms_article_class&fun=cms_article_class_save">
