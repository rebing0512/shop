...
function update_flex(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=web_channel&fun=get_channel_xml',
        colModel : [
...
function fg_operation_add(name, bDiv){
    var _url = 'index.php?con=web_channel&fun=add_channel';
    window.location.href = _url;
}
function fg_operation_del(channel_id){
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        var _url = 'index.php?con=web_channel&fun=del_channel&channel_id='+channel_id;
