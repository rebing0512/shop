  ...
  <div class="ncm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class=" ncm-default-form">
        <div id="warning"></div>
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?con=member_vr_refund&fun=add_refund&order_id=<?php echo $output['order']['order_id']; ?>">
