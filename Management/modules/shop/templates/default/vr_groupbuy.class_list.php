...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>虚拟特卖</h3>
        <h5>虚拟商品特卖促销活动相关设定及管理</h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="javascript:;" class="current">分类管理</span></a></li>
        <li><a href="index.php?con=vr_groupbuy&fun=area_list">区域管理</a></li>
      </ul>
    </div>
  </div>
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>商家发布虚拟商品的特卖时，需要选择虚拟特卖所属分类</li>
      ...
      <tbody>
        ...
        <tr class="hover edit" data-id="<?php echo $val['class_id']; ?>">
          ...
          <td class="handle"><a href="javascript:;" onclick="submit_delete(<?php echo $val['class_id']; ?>)" class="btn red"><i class="fa fa-trash-o"></i>删除</a> <span class="btn"> <em><i class="fa fa-cog"></i>设置<i class="arrow"></i></em>
            <ul>
              <li><a href="index.php?con=vr_groupbuy&fun=class_edit&class_id=<?php echo $val['class_id']; ?>">编辑分类</a></li>
              <li><a href="index.php?con=vr_groupbuy&fun=class_add&parent_class_id=<?php echo $val['class_id']; ?>">新增下级</a></li>
            </ul>
            </span></td>
        ...
        <tr class="<?php echo 'class_id'.$val['class_id'];?>" style="display:none;" data-id="<?php echo $val1['class_id']; ?>">
          <td></td>
          <td class="handle"><a href="javascript:;" onclick="submit_delete(<?php echo $val1['class_id']; ?>)" class="btn red"><i class="fa fa-trash-o"></i>删除</a> <a href="index.php?con=vr_groupbuy&fun=class_edit&class_id=<?php echo $val1['class_id']; ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a></td>
...
function submit_delete(id) {
    if (confirm('<?php echo $lang['nc_ensure_del']; ?>')) {
        ...
        $('#list_form').attr('action','index.php?con=vr_groupbuy&fun=class_del');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
