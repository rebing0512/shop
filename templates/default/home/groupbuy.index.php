...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span> <span>商城特卖</span></div>
</div>
...
<?php } ?>
  ...
  <div class="ncg-content">
    ...
    <div class="group-list mt20">
      ...
      <?php } else { ?>
      <div class="norecommend">暂无线上特卖推荐</div>
      <?php } ?>
    </div>
    <div class="group-list mt30">
      ...
      <?php } else{ ?>
      <div class="norecommend">暂无虚拟特卖推荐</div>
      <?php } ?>
    </div>
  </div>
</div>
