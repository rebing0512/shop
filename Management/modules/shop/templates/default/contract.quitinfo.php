...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=contract&fun=quitlist" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <div class="bot"><a class="ncap-btn-big ncap-btn-green" href="index.php?con=contract&fun=quitlist">返回列表</a></div>
    </div>
</div>