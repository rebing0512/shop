    ...
    public function get_xmlOp() {
        ...
        foreach ($cirlce_list as $value) {
            ...
            if ($value['circle_status'] == '2') {
                $operation .= "<a class='btn orange' href='index.php?con=circle_manage&fun=circle_edit&c_id=".$value['circle_id']."' class='url'><i class='fa fa-pencil-square-o'></i>审核</a>";
            } else {
                $operation .= "<a class='btn blue' href='index.php?con=circle_manage&fun=circle_edit&c_id=".$value['circle_id']."' class='url'><i class='fa fa-pencil-square-o'></i>编辑</a>";
            }
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($rs){
                    ...
                    showMessage(L('nc_common_op_succ'), 'index.php?con=circle_manage&fun=circle_list');
                }else{
                    showMessage(L('nc_common_op_fail'));
                }
            }
