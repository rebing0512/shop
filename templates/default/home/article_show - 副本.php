    ...
    <div class="nch-module nch-module-style03">
      ...
      <div class="content">
        <ul class="nch-sidebar-article-list">
          ...
          <li><i></i><a <?php if($v['article_url']!=''){?>target="_blank"<?php }?> href="<?php if($v['article_url']!='')echo $v['article_url'];else echo urlShop('article', 'show', array('article_id'=>$v['article_id']));?>"><?php echo str_cut($v['article_title'],28,'......')?></a></li>
          <?php }?>
          <?php }else{?>
