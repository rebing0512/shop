    ...
    <form id="store_form" method="post">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dl class="row">
              <dt class="tit">
                  <label for="member_email"><em></em>名片ID</label>
              </dt>
              <dd class="opt">
                  <input type="text" value="<?php echo $output['store_array']['businesscard_id'];?>" id="businesscard_id" name="businesscard_id" class="input-txt">
                  <span class="err"></span>
                  <p class="notic">输入绑定名片ID，在信息->设置->名片设置处查看名片ID</p>
              </dd>
          </dl>
          <dl class="row">
              <dt class="tit">
                  <label for="store_sort"><em>*</em>店铺排序</label>
              </dt>
              <dd class="opt">
                  <input type="text" value="<?php echo $output['store_array']['store_sort']?>" id="store_sort" name="store_sort" class="input-txt"/>
                  <span class="err"></span>
                  <p class="notic">数字越小，排序靠前</p>
              </dd>
          </dl>
          <dl class="row">
              <dt class="tit">
                  <label for="store_type"><em>*</em>店铺类型</label>
              </dt>
              <dd class="opt">
                  <label>
                      <input type="radio" checked="checked" value="0" name="store_type" <?php if ($output['store_array']['store_type'] == 0){echo 'checked';}?>>
                      普通</label>
                  <label>
                      <input type="radio" value="2" name="store_type" <?php if ($output['store_array']['store_type'] == 2){echo 'checked';}?>>
                      认证</label>
                  <label>
                      <input type="radio" value="4" name="store_type" <?php if ($output['store_array']['store_type'] == 4){echo 'checked';}?>>
                      高级</label>
                  <span class="err"></span>
              </dd>
          </dl>
