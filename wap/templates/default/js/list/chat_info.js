...
$(function() {
    ...
    $.getJSON(ApiUrl + "/index.php?con=member_chat&fun=get_node_info", {
    ...
    function(t) {
        ...
        if (!$.isEmptyObject(t.datas.chat_goods)) {
            ...
            var s = '<div class="nctouch-chat-product"> <a href="' + ApiUrl + "/index.php?con=goods&fun=detail&goods_id=" + a.goods_id + '" target="_blank"><div class="goods-pic"><img src="' + a.pic24 + '" alt=""/></div><div class="goods-info"><div class="goods-name">' + a.goods_name + '</div><div class="goods-price">￥' + a.goods_promotion_price + "</div><p><a href='javascript:;' class='send_goods_url'>发送链接</a></p></div></a> </div>";
    ...
    var e = function(e) {
        ...
        function s() {
            ...
            function s(e) {
                ...
                if (t === 1) {
                    ...
                    $.ajax({
                        ...
                        url: ApiUrl + "/index.php?con=member_chat&fun=send_msg",
            ...
            $(".send_goods_url").click(function(){
                var goods_url = $(".nctouch-chat-product a").attr("href");
                var goods_name = $(".goods-name").html();
        ...
        $("#chat_msg_log").click(function() {
            ...
            $.ajax({
                ...
                url: ApiUrl + "/index.php?con=member_chat&fun=get_chat_log&page=50",
