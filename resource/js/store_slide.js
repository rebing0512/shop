...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?con=store_setting&fun=silde_image_upload';
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getJSON('index.php?con=store_setting&fun=dorp_img', {file_id : file_id, img_src : img_src}, function(data) {
