...
<div class="wrap">
  ...
  <div class="ncm-friend-find"> 
    <!-- 搜索好友start -->
    <form method="post" id="search_form" action="index.php?con=member_snsfriend&fun=findlist">
      ...
      <ul class="ncm-friend-list">
        ...
        <li id="recordone_<?php echo $v['member_id']; ?>">
          ...
          <dl class="info">
            ...
            <dd><a href="<?php echo urlShop('member_message', 'index', array('member_id' => $v['member_id']));?>;" target="_blank"><i class="icon-envelope"></i><?php echo $lang['nc_message'] ;?></a></dd>
          </dl>
