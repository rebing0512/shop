      ...
      <?php
          ...
          <p class='notic'>".$lang['ap_show_defaultpic_when_nothing'].",".$lang['adv_edit_support']."gif,jpg,jpeg,png</p>
				        ...
				        if($v['ap_display'] == '1'){
				 		...
				 		if($v['ap_setting_anniu_wenzi'] == '1'){
				 			$selected_state1 = "selected";
				 			$selected_state2 = "";
				 		}else{
				 			$selected_state1 = "";
				 			$selected_state2 = "selected";
				 		}
				 		echo "<dl class='row'>
								<dt class='tit'>
									<label>".$lang['ap_class']."</label>
          ...
          <p class='notic'>".$lang['ap_show_defaultpic_when_nothing'].",".$lang['adv_edit_support']."gif,jpg,jpeg,png</p>
					 ...
					 echo "<dl class='row' id='ap_setting_anniu_wenzi_show'><dt class='tit'><label for='ap_setting_anniu_wenzi'><em>*</em>轮播图切换文字显示</label></dt><dd class='opt'><select name='ap_setting_anniu_wenzi' id='ap_setting_anniu_wenzi'>
			            <option value='0' ".$selected_state2.">不显示</option>
			            <option value='1' ".$selected_state1.">显示</option>
			          </select>
			          <span class='err'></span>
			      ...
			      echo "<dl class='row' id='ap_setting_anniu_weizhi' >
				        <dt class='tit'>
				          <label for='ap_setting_anniu_weizhi'><em>*</em>轮播图切换卡按钮位置编辑</label>
				        </dt>
				        <dd class='opt'>
				          
				          <textarea  name='ap_setting_anniu_weizhi' class='input-txt' id='ap_setting_anniu_weizhi_input'  style='height:72px;'>".$v['ap_setting_anniu_weizhi']."</textarea>
				          <span class='err'></span>
				          <p class='notic'>轮播图切换卡按钮位置编辑</p>
				        </dd>
				      </dl>
				        <dl class='row' id='ap_setting_anniu_ys' >
				        <dt class='tit'>
				          <label for='ap_setting_anniu_ys'><em>*</em>轮播图切换卡按钮选中样式编辑</label>
				        </dt>
				        <dd class='opt'>
				         <textarea  name='ap_setting_anniu_ys' class='input-txt' id='ap_setting_anniu_ys_input'  style='height:72px;'>".$v['ap_setting_anniu_ys']."</textarea>
				         ...
				         <dl class='row' id='ap_setting_anniu_ys_after' >
				        <dt class='tit'>
				          <label for='ap_setting_anniu_ys_after'><em>*</em>轮播图切换卡按钮默认样式编辑</label>
				        </dt>
				        <dd class='opt'>
				         <textarea  name='ap_setting_anniu_ys_after' class='input-txt' id='ap_setting_anniu_ys_after_input'  style='height:72px;'>".$v['ap_setting_anniu_ys_after']."</textarea>
				          <span class='err'></span>
				          <p class=
	...
	$("#textfield1").val($("#change_default_pic").val());
	 ...
	 $("#ap_setting_anniu_wenzi").change(function(){
      ...
      if($("#ap_setting_anniu_wenzi").val() == 0){
        ...
        $("#ap_setting_anniu_ys_after_input").val('display: none;height: 35px;color:#fff;line-height:35px;text-indent:1em;');
