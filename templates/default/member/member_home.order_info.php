    ...
    <div class="title">
      ...
      <ul>
        <li>
          ...
          <a href="index.php?con=member_order&state_type=state_new"><?php echo $lang['nc_order_waitpay'];?><em><?php echo $output['home_member_info']['order_nopay_count'];?></em></a>
          <?php } else { ?>
        ...
        <li>
          ...
          <a href="index.php?con=member_order&state_type=state_send"><?php echo $lang['nc_order_receiving'];?><em><?php echo $output['home_member_info']['order_noreceipt_count'];?></em></a>
          <?php } else { ?>
        ...
        <li>
          ...
          <a href="index.php?con=member_order&state_type=state_noeval"><?php echo $lang['nc_order_waitevaluate'];?><em><?php echo $output['home_member_info']['order_noeval_count'];?></em></a>
          <?php } else { ?>
        ...
        <li>
          ...
          <dl class="ncm-goods-info">
            ...
            <dd><span class="order-state">订单状态：<?php echo orderState($order_info);?>
              ...
              <a href='index.php?con=member_order&fun=search_deliver&order_id=<?php echo $order_info['order_id']; ?>&order_sn=<?php echo $order_info['order_sn']; ?>' target="_blank"><i class="icon-truck"></i>查看物流</a>
              <?php } ?>
              </span> </dd>
          </dl>
          <?php if ($order_info['if_payment']) {?>
          <a href="index.php?con=buy&fun=pay&pay_sn=<?php echo $order_info['pay_sn'];?>" target="_blank" class="ncbtn ncbtn-bittersweet"><i class="icon-shield"></i>订单支付</a>
          <?php } ?>
          ...
          <a href="index.php?con=member_evaluate&fun=add&order_id=<?php echo $order_info['order_id']; ?>" target="_blank" class="ncbtn ncbtn-mint"><i class="icon-comments-alt"></i>交易评价</a>
          <?php } ?>
          <?php if (!$order_info['if_payment'] && !$order_info['if_receive'] && !$order_info['if_evaluation']) {?>
          <a href="index.php?con=member_order&fun=show_order&order_id=<?php echo $order_info['order_id'];?>" target="_blank" class="ncbtn ncbtn-mint"><i class="icon-eye-open"></i>查看订单</a>
          <?php } ?>
        </li>
        <?php } ?>
      </ul>
...
<div id="shopping" class="normal">
  <div class="outline">
    ...
    <div class="cart-list">
      ...
      <div class="more"><a href="index.php?con=cart">查看购物车所有商品</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
