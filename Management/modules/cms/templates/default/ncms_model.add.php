...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=ncms_model&fun=ncms_model_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_ncms_model_manage'];?> - <?php echo $lang['nc_new'];?></h3>
        <h5><?php echo $lang['nc_ncms_model_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?con=ncms_model&fun=ncms_model_save">
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input id="tablename" name="tablename" type="text" class="input-txt" value="" />
          <span class="err"></span>
       ...
       <dl class="row">
        <dt class="tit">
         ...
         <dd class="opt">
          <textarea class="tarea" rows="6" name="description" id="description"></textarea>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
