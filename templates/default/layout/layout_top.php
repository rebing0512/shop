  ...
  <div class="user-login-box" nctype="barLoginBox" style="display:none;"> <i class="arrow"></i> <a href="javascript:void(0);" class="close-a" nctype="close-barLoginBox" title="关闭">X</a>
            ...
            <dl>
              ...
              <dd>
                ...
                <label></label>
                        ...
                        <dl>
              <dt><strong>验证码</strong><a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?con=seccode&amp;fun=makecode&amp;nchash=<?php echo getNchash('login','index');?>&amp;t=' + Math.random();">更换验证码</a></dt>
              <dd>
      ...
      <h4><?php echo $lang['nc_otherlogintip'];?></h4>
              ...
              <?php if (C('sina_isuse') == 1){?>
                                          <a href="<?php echo SHOP_SITE_URL;?>/api.php?con=tosina" title="新浪微博账号登录" class="mr20">新浪微博</a><?php } ?>
                                          <?php if (C('qq_isuse') == 1){?><a href="<?php echo SHOP_SITE_URL;?>/api.php?con=toqq" title="QQ账号登录" class="mr20">QQ账号</a><?php } ?><?php } ?>
                          </div>
          </form>
        </div>
    <?php }?>
...
$(function() {
  $(function() {
    ...
    $('#ncHideBar').click(function() {
      ...
      function() {
        $('#content-cart').animate({'right': '-250px'});
        $('#content-compare').animate({'right': '-250px'});
        $('#ncToolbar').animate({'right': '6px'},300);
      });
    });
  });
    ...
    $("#rtoolbar_cart").click(function(){
        ...
        if (!$("#rtoolbar_cartlist").html()) {
          $("#rtoolbar_cartlist").load('index.php?con=cart&fun=ajax_load&type=html');
        }
        } else {
          $(".close").click();
          $(".chat-list").css("display",'none');
  ...
  function() {
    ...
    $('div[nctype="a-barLoginBox"]').click(function(){
        ...
        document.getElementById('codeimage').src='index.php?con=seccode&fun=makecode&nchash=<?php echo getNchash('login','index');?>&t=' + Math.random();
...
<?php } ?>
<div>
<?php if ($output['setting_config']['control_top_banner_status']>0){ ?>
<div style=" background:<?php echo $output['setting_config']['control_top_banner_color']; ?>;">
<div class="wrapper" id="t-sp" style="display: none;">
<a href="javascript:void(0);" class="close" title="关闭"></a>
<a href="<?php echo $output['setting_config']['control_top_banner_url']; ?>" title="<?php echo $output['setting_config']['control_top_banner_name']; ?>"><img border="0" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['control_top_banner_pic']; ?>" alt=""></a></div>
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <span class="other">
      <?php if (C('qq_isuse') == 1){?>
      <a href="<?php echo SHOP_SITE_URL;?>/api.php?con=toqq" title="QQ账号登录" class="qq"><i></i></a>
      <?php } ?>
      <?php if (C('sina_isuse') == 1){?>
      <a href="<?php echo SHOP_SITE_URL;?>/api.php?con=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina"><i></i></a>
      <?php } ?>
         <?php if (C('weixin_isuse') == 1){?>
      ...
      <?php }?>
      	<span style="margin-left:10px;"><a href="index.php?con=invite" style="color:red;">邀请返利</a></span> <!--20160904-->
    </div>
...
<!-- 	<?php if (C('mobile_isuse') && C('mobile_app')){?>
	...
	<dl>
      ...
      <dl>
        <dt><em class="ico_order"></em><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_order">我的订单</a><i></i></dt>
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_order&state_type=state_new">待付款订单</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_order&state_type=state_send">待确认收货</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_order&state_type=state_noeval">待评价交易</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
        <dt><em class="ico_store"></em><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_favorite_goods&fun=fglist"><?php echo $lang['nc_favorites'];?></a><i></i></dt>
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_favorite_goods&fun=fglist">商品收藏</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_favorite_store&fun=fslist">店铺收藏</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
