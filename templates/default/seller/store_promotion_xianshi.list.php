...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="con" value="store_promotion_xianshi" />
  ...
  <tbody id="xianshi_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr"><?php if($val['editable']) { ?>
        <span> <a href="index.php?con=store_promotion_xianshi&fun=xianshi_edit&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-bluejeans"> <i class="icon-edit"></i>
        <p><?php echo $lang['nc_edit'];?></p>
        </a> </span>
        <?php } ?>
        <span> <a href="index.php?con=store_promotion_xianshi&fun=xianshi_manage&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-mint"> <i class="icon-cog"></i>
