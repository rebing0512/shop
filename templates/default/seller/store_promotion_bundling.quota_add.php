...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="index.php?con=store_promotion_bundling&fun=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?con=store_promotion_bundling&fun=bundling_renew" method="post">
  <?php }?>
