...
<div class="page">
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="index.php?con=web_config&fun=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_web_html'];?></a></div>
    </div>
  </form>
</div>
