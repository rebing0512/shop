...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=payment" title="返回支付方式列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="post_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['payment_jdpay_account'];?></dt>
        <dd class="opt">
          <input type="hidden" name="config_name" value="jdpay_account,jdpay_key" />
          <input name="jdpay_account" id="jdpay_account" value="<?php echo $output['config_array']['jdpay_account'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit"><?php echo $lang['payment_jdpay_key'];?></dt>
        <dd class="opt">
          <input name="jdpay_key" id="jdpay_key" value="<?php echo $output['config_array']['jdpay_key'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
	$('#post_form').validate({
        ...
        messages : {
            jdpay_account  : {
                required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['payment_jdpay_account'];?><?php echo $lang['payment_edit_not_null']; ?>'
            },
            jdpay_key  : {
                required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['payment_jdpay_key'];?><?php echo $lang['payment_edit_not_null']; ?>'
            }
        }
		<?php } elseif ($output['payment']['payment_code'] == 'tenpay') { ?>
        rules : {
