...
<div class="eject_con">
  <div id="warning"></div>
  <form action="index.php?con=cut&fun=pic_cut" id="form_cut" method="post">
...
$(function(){
    ...
    $('#pic_submit').click(function(){
        ...
        <?php else:?>
            var id = '';
        <?php endif;?>
//        var id = "<?//= $_GET['id']?:('&id='.$_GET['id'])?>//";
		$.post('index.php?con=cut&fun=pic_cut'+id,d,function(data,id = ''){
			call_back(data);
