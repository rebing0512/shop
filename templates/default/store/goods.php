        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-price weui-row_active"><?php echo $lang['currency'];?><?php echo $goods_commend['goods_promotion_price'];?></dd>
            </dl>
          </li>
          <?php }?>
          <?php }?>
...
<div id="content" class="ncs-goods-layout expanded" >
  <div class="ncs-goods-main" id="main-nav-holder">
   ...
   <div class="main-right"><div class="zs-quick-menu"><ul style="display: block;"><li class="cur"><a href="#ncGoodsIntro">商品介绍</a></li><?php if ($output['goods']['is_virtual'] == 1) {?><li><a href="#ncStoreMap">店铺地图</a></li><?php }?><li><a href="#ncGoodsRate">商品评价</a></li><li><a href="#ncGoodsTraded">销售记录</a></li><li><a href="#ncGuestbook">购买咨询</a></li></ul></div></div> <!--youce-->
  ...
  <div class="ncs-sidebar">
    ...
    <div class="ncs-sidebar-container ncs-top-bar">
      ...
      <div class="content">
        ...
        <p><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_goodsbrowse&fun=list" class="nch-sidebar-all-viewed">全部浏览历史</a></p> </div>
    </div>
    <?php } ?>
  </div>
</div>
...
<form id="buynow_form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php">
  <input id="act" name="con" type="hidden" value="buy" />
...
$(function(){
    ...
    <?php if ($output['goods']['is_virtual'] == 1) {?>
    $("#ncStoreMap").load('index.php?con=show_map&fun=index&w=420&h=400&store_id=<?php echo $output['goods']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
    <?php } ?>
    $("#salelog_demo").load('index.php?con=goods&fun=salelog&goods_id=<?php echo $output['goods']['goods_id'];?>&store_id=<?php echo $output['goods']['store_id'];?>&vr=<?php echo $output['goods']['is_virtual'];?>', function(){
        // Membership card
