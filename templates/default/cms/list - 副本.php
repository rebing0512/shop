...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/news.css" rel="stylesheet" type="text/css">
 ...
 <section class="essay_right">
        ...
        <a class="list_zx" href="<?php echo urlShop('cms_index', 'list', array('catid'=>$v['catid']));?>" title="<?php echo $v['catname']?>">
          <img src="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_ARTICLE_LOGO.DS.$v['image']);?>" title="<?php echo $v['catname']?>" height="25"><?php echo $v['catname']?>
        </a>
        <?php }?>
                            ...
                            <dd>
                                ...
                                <div class="content_img">
                                  <a <?php if($article['islink']==1){?>target="_blank"<?php }?> href="<?php if($article['url']!='')echo $article['url'];else echo urlShop('cms_index', 'details', array('catid'=>$article['catid'],'id'=>$article['id']));?>">
                                        <img src="<?php echo $article['sthumb'];?>"></a>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="btn">
                                        <a class="left" href="<?php echo urlShop('article', 'article', array('ac_id'=>$article['ac_id']));?>">
                                          <i class="dgou" style="background:none"><img src="<?php echo $article['classico'];?>" style="width:26px;height:26px;"></i><?php echo $article['classname'];?>
                                        </a>
