...
class store_upload_albumModel extends Model {
    /**
     * 列表
     *
    ...
    public function add($param){
        ...
        if (is_array($param)){
            $result = Db::insert('store_album_list',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('store_album_list',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function updatebywhere($param,$conditionarr){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('store_album_list',$tmp,$condition_str);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('store_album_list',$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function dropUploadById($id){
        ...
        $result = Db::delete('store_album_list',$condition_str);
        return $result;
    }
    //
    //
