...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=web_channel&fun=web_channel" title="返回频道列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic">
            ...
            选择分类后，频道顶部切换焦点大图右侧会自动调用该分类下的特卖和限时折扣促销商品，特卖的商品优先，无数据时不显示。<br/></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
...
function check_goods_class() {
    ...
    if (gc_id>0 && gc_id!="<?php echo $output['gc_id'];?>") {
    	var get_text = $.ajax({
    		url: 'index.php?con=web_channel&fun=check_goods_class&gc_id='+gc_id,
    		async: false
    		}).responseText;
    	if(get_text!='') {
...
function get_floor() {
	...
	$("#show_floor_list").load('index.php?con=web_channel&fun=get_channel_fl&'+$.param({'name':f_name }));
}
