...
class stat_aftersaleControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_aftersale&fun=refund','lang'=>'stat_refund'),
        array('url'=>'con=stat_aftersale&fun=evalstore','lang'=>'stat_evalstore'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['fun']) || in_array($this->search_arr['fun'],array('refund','refundlist','get_refundlist_xml','get_refund_highcharts'))){
