...
<style type="text/css">
    ...
    #goods_list .times_show .ico_time {
        width: 0.85rem;
        height: 0.85rem;
        background-image: url(<?php echo MOBILE_TEMPLATES_URL;?>/images/times_show.png);
        background-size: 100%;
    ...
    .input-boxt em.checked {
        background-color: transparent !important;
        padding: 0 !important;
        color: #555 !important;
    }

    .input-boxt em input[type="checkbox"] {
        display: none;
    }
    ...
    .input-boxt em.checked .power {
        background-color: #48CFAE;
        border-color: #48CFAE;
    }

    .input-boxt em.checked .power i {
        left: auto;
        right: 0;
        box-shadow: -0.05rem 0.1rem 0.25rem rgba(0, 0, 0, 0.3);
    }
...
<div class="nctouch-main-layout">
    ...
    <div class="nctouch-order-search">
      ...
      <span><input type="text" autocomplete="on" maxlength="50" placeholder="关键字进行搜索" name="keyword" id="keyword"
    ...
    <a class="btn-add mt5 mb5" href="<?php echo urlMobile('category'); ?>">+添加商品</a>
    ...
    <div class="nctouch-order-list" style="margin-top: 0;">
...
<script type="text/html" id="order-list-tmpl">
    ...
    <li goods_id="<%=glsit.goods_commonid%>" class="goods_id_<%=glsit.goods_commonid%>">
        ...
        <div class="list_zz" goods_id="<%=glsit.goods_id%>" goods_commonid="<%=glsit.goods_commonid%>">
    ...
    <div class="nctouch-norecord order">
        ...
        <a href="javascript:;" onclick="window.MBC.to_shop_index('<%=ApiUrl%>')" class="btn">随便逛逛</a>
