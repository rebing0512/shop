...
<div class="alert alert-block mt10">
  <ul>
    <li>1、只有使用移动设备（Wap）购买参加促销的商品才能享受手机专享折扣。</li>
  </ul>
</div>
<?php } else { ?>
<!-- 有可用套餐，发布活动
...
<?php }?>
  <ul>
    ...
    <li>3、只有使用移动设备（Wap）购买参加促销的商品才能享受手机专享折扣。</li>
  </ul>
</div>
<?php } ?>
-->
...
<div nctype="div_goods_select" class="div-goods-select" style="display: none;">
    <table class="search-form">
      <tr><th class="w150"><strong>第一步：搜索店内商品</strong></th><td class="w160"><input nctype="search_goods_name" type="text w150" class="text" name="goods_name" value=""/></td>
        <td class="w70 tc"><label class="submit-border"><input nctype="btn_search_goods" type="button" value="<?php echo $lang['nc_search'];?>" class="submit"/></label></td><td class="w10"></td><td><p class="hint">不输入名称直接搜索将显示店内所有出售中的商品,注意（特殊商品不在活动范畴内）</p></td>
      </tr>
    </table>
