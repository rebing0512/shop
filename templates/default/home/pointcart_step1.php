...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?con=pointcart&fun=step2">
      <div class="ncc-receipt-info">
        <div class="ncc-receipt-info-title">
          <h3><?php echo $lang['pointcart_step1_receiver_address'];?><a href="<?php echo urlShop('member_address', 'address');?>" target="_blank">[管理]</a></h3>
        </div>
        <!-- 已经存在的收获地址start -->
        <div class="ncc-candidate-items">
          ...
          <?php } ?>
          <?php } else { ?>
          <div style="color:02a129; height:25px; padding-top:3px;">暂无收货人地址，请先点击上方 “ 【管理】 ” ，新增收货地址，再进行兑换吧！</div>
          <?php }?>
        </div>
        <!-- 已经存在的收获地址end --> 
      </div>
      ...
      <div class="ncc-receipt-info">
        ...
        <table class="ncc-table-style">
          ...
          <tfoot>
            <tr>
              <td colspan="20"><a href="index.php?con=pointcart" class="ncc-prev-btn"><i class="icon-angle-left"></i><?php echo $lang['pointcart_step1_return_list'];?></a>
