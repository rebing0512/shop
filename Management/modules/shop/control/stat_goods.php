...
class stat_goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_goods&fun=pricerange','lang'=>'stat_goods_pricerange'),
        array('url'=>'con=stat_goods&fun=hotgoods','lang'=>'stat_hotgoods'),
        array('url'=>'con=stat_goods&fun=goods_sale','lang'=>'stat_goods_sale'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['fun']) || in_array($this->search_arr['fun'],array('pricerange','hotgoods','goods_sale','get_goods_xml'))){
