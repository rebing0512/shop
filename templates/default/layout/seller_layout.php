...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo SHOP_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_RESOURCE_SITE_URL = '<?php echo SHOP_RESOURCE_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';</script>
  ...
  <div class="wrapper">
    <div class="ncsc-admin">
      <dl class="ncsc-admin-info">
        ...
        <dd class="admin-permission"><?php echo $_SESSION['seller_name'];?></dd>
        <dd class="admin-name">站内消息(<?php echo $output['store_msg_num'];?>)</dd>
      </dl>
      <div class="ncsc-admin-function">
          <a href="<?php echo urlShop('seller_center', 'index');?>" title="回到首页" >
              <i class="icon-home"></i>
          </a>
<!--          echo urlShop('member_security', 'auth',array('type'=>'modify_pwd'));-->
          <a href="javascript:;" title="修改密码" target="_blank">
        ...
        <div class="sitemap-menu">
          ...
          <div id="quicklink_list" class="content">
            ...
            <dl <?php echo ($key == 'promotion' ? 'class="double"' : '');?>>
              ...
              <dd <?php if(!empty($output['seller_quicklink'])) {echo in_array($submenu_value['con'], $output['seller_quicklink'])?'class="selected"':'';}?>><i nctype="btn_add_quicklink" data-quicklink-act="<?php echo $submenu_value['con'];?>" class="icon-check" title="添加为常用功能菜单"></i><a href="index.php?con=<?php echo $submenu_value['con'];?>&fun=<?php echo $submenu_value['fun'];?>"> <?php echo $submenu_value['name'];?> </a></dd>
              <?php } ?>
              <?php } ?>
            </dl>
            <?php } ?>
...
<!--      </div>-->
    ...
    <nav class="ncsc-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="index.php?con=seller_center&fun=index">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
      ...
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="index.php?con=<?php echo $menu_value['child'][key($menu_value['child'])]['con'];?>&fun=<?php echo $menu_value['child'][key($menu_value['child'])]['fun'];?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="index.php?con=<?php echo $submenu_value['con'];?>&fun=<?php echo $submenu_value['fun'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['con'] == 'seller_center'?"id='quicklink_".$submenu_value['con']."'":'';?>class="<?php echo $submenu_value['con'] == $_GET['con']?'current':'';?>"> <a href="index.php?con=<?php echo $submenu_value['con'];?>&fun=<?php echo $submenu_value['fun'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
          <?php if ($_GET['con'] == 'seller_center') { ?>
