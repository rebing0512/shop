...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=circle_theme&fun=theme_list" title="返回<?php echo $lang['circle_theme_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"> <a href="index.php?con=circle_theme&fun=theme_reply&t_id=<?php echo $output['theme_info']['theme_id'];?>" class="ncap-btn-big ncap-btn-blue mr10"><?php echo $lang['circle_theme_check_reply'];?></a> <a href="JavaScript:void(0);" onclick="if(confirm('<?php echo $lang['circle_theme_del_confirm'];?>')){location.href='index.php?con=circle_theme&fun=theme_del&c_id=<?php echo $output['theme_info']['circle_id'];?>&t_id=<?php echo $output['theme_info']['theme_id'];?>';}else{return false;}" class="ncap-btn-big ncap-btn-red" id="delTheme"><?php echo $lang['circle_theme_del'];?></a></div>
    </div>
  </form>
</div>
