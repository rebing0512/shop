...
class stat_industryControl extends SystemControl{
    private $links = array(
        array('url'=>'con=stat_industry&fun=scale','lang'=>'stat_industryscale'),
        array('url'=>'con=stat_industry&fun=rank','lang'=>'stat_industryrank'),
        array('url'=>'con=stat_industry&fun=price','lang'=>'stat_industryprice'),
        array('url'=>'con=stat_industry&fun=general','lang'=>'stat_industrygeneral'),
    );
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (!isset($this->search_arr['fun']) || in_array($this->search_arr['fun'],array('scale','rank','price'))){
        ...
        if (!isset($this->search_arr['fun']) || in_array($this->search_arr['fun'],array('scale','general'))){//仅显示前两级分类
            $show_depth = 2;
        }
