...
<div class="register-mobile-tip"> 您当前的手机号码是<em id="mobile"><?php echo $output['member_mobile'];?></em></div>
...
<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/list/member_paypwd_step1.js"></script> 
