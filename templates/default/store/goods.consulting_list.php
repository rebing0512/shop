...
<div class="wrapper">
  <div class="ncs-goods-layout expanded" >
    <div class="ncs-goods-main">
          ...
          <div class="ncs-cosult-list">
            <dl class="asker">
              ...
              <dd>
                ...
                <?php }else{?>
                <a href="index.php?con=member_snshome&mid=<?php echo $v['member_id'];?>" target="_blank" data-param="{'id':<?php echo $v['member_id'];?>}" nctype="mcard"><?php echo str_cut($v['member_name'],8);?></a>
                <?php }?>
      ...
      <form method="post" id="message" action="index.php?con=goods&fun=save_consult">
        ...
        <div class="ncs-consult-form">
          ...
          <dl>
            ...
            <dd>
              ...
              <div class="code">
                <div class="arrow"></div>
                <div class="code-img"><a href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?con=seccode&fun=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();"><img src="index.php?con=seccode&fun=makecode&nchash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?con=seccode&fun=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"/></a></div>
                <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a> <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?con=seccode&fun=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['goods_index_change_checkcode'];?>"><i></i></a> </div>
              <?php } ?>
      ...
      <div class="ncs-sidebar-container">
        ...
        <div class="content">
          <dl class="ncs-comment-goods">
            ...
            <dd class="goods-price weui-row_active"><?php echo $lang['goods_index_goods_price'].$lang['nc_colon'];?><em class="saleP"><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_promotion_price']);?></em></dd>
