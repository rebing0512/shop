  ...
  <form id="form_image" action="">
    <div class="ncap-form-default">
     <dl class="row">
      ...
      <dl class="row">
        <dt class="tit">导航颜色：</dt>
        <dd class="opt">
          <input id="dialog_item_image_color" type="text" class="txt w160  marginbot ">
...
<script id="item_image_template" type="text/html">
    <div nctype="item_image" class="item">
        ...
        <input nctype="image_color" name="item_data[item][<%=image_name%>][color]" type="hidden" value="<%=image_color%>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('[nctype="btn_edit_item_image"]').on('click', function() {
            ...
            $current_image_color = $item_image.find('[nctype="image_color"]');
            ...
            $('#dialog_item_image_color').val($current_image_color.val());
            $(".evo-colorind-ff").css({'background':$current_image_color.val()});
        ...
        function edit_item_image_save() {
            ...
            $current_image_color.val($('#dialog_item_image_color').val());
        }
        ...
        function add_item_image_save() {
            ...
            item.image_color = $('#dialog_item_image_color').val();
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#dialog_item_image_color").colorpicker();
    });
</script>