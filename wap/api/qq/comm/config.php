...
$_SESSION["appid"]    = trim($data['app_qq_akey']);

//申请到的appkey
//$_SESSION["appkey"]   = "yourappkey"; 
$_SESSION["appkey"]   = trim($data['app_qq_skey']);

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
//$_SESSION["callback"] = "http://your domain/oauth/get_access_token.php"; 
$_SESSION["callback"] = MOBILE_SITE_URL."/api.php?con=toqq&fun=g";
