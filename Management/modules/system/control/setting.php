...
class settingControl extends SystemControl{
    ...
    public function baseOp(){
        ...
        if (chksubmit()){
            ...
            $update_array['operating_unit'] = $_POST['operating_unit'];
            $update_array['web_url'] = $_POST['web_url'];
            ...
            $update_array['site_kuaidi'] = trim($_POST['site_kuaidi']);
    ...
    {
        /*
        http://你的程序地址/crontab/index.php?con=minutes
        http://你的程序地址/crontab/index.php?con=hour
        http://你的程序地址/crontab/index.php?con=date
        http://你的程序地址/crontab/index.php?con=month
        */
        //zmr>v30
        header("content-type:text/html; charset=utf-8"); 
        $page=BASE_SITE_URL.'/crontab/cj_index.php?con=minutes';
        $html = file_get_contents($page,'r');
        echo '分钟任务执行成功'.$html; 
        echo "<br/>";
        $page=BASE_SITE_URL.'/crontab/cj_index.php?con=hour';
        $html = file_get_contents($page,'r');
        echo '小时任务执行成功'.$html; 
        echo "<br/>";
        $page=BASE_SITE_URL.'/crontab/cj_index.php?con=date';
        $html = file_get_contents($page,'r');
        echo '每天任务执行成功'.$html; 
        echo "<br/>";
        $page=BASE_SITE_URL.'/crontab/cj_index.php?con=month';
        $html = file_get_contents($page,'r');
        echo '每月任务执行成功'.$html; 
        echo "<br/>";
        echo "<br/>全部计划任务执行成功";
