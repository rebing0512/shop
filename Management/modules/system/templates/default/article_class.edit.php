...
<div class="page">
  ...
  <form id="article_class_form" method="post" name="articleClassForm" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      <dl class="row">
       ...
       <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_ARTICLE_LOGO.DS.$output['class_array']['ac_logo']);?>"> <i class="fa fa-picture-o" onMouseOver="toolTip('<img src=<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_ARTICLE_LOGO.DS.$output['class_array']['ac_logo']);?>>')" onMouseOut="toolTip()"/></i> </a></span><span class="type-file-box">
            ...
            <input type="hidden" name="pic_ori" value="<?php echo $output['class_array']['ac_logo'];?>">
            </span></div>
          <span class="err"></span>
