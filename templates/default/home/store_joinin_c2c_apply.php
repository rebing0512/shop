  ...
  <div class="sidebar">
    ...
    <div class="content">
        ...
        <dd style="display:none;">
          <ul>
                                    <li> <i></i>
                            <a href="index.php?con=show_help&fun=index&t_id=99&help_id=101" target="_blank">签署入驻协议</a>
                          </li>
                        <li> <i></i>
                            <a href="index.php?con=show_help&fun=index&t_id=99&help_id=102" target="_blank">商家信息提交</a>
                          </li>
                        <li> <i></i>
                            <a href="index.php?con=show_help&fun=index&t_id=99&help_id=103" target="_blank">平台审核资质</a>
                          </li>
                        <li> <i></i>
                            <a href="index.php?con=show_help&fun=index&t_id=99&help_id=104" target="_blank">商家缴纳费用</a>
                          </li>
                        <li> <i></i>
                            <a href="index.php?con=show_help&fun=index&t_id=99&help_id=105" target="_blank">店铺开通</a>
                          </li>
                                  </ul>
        </dd>
      </dl>-->
