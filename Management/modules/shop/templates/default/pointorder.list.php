  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?con=pointprod&fun=pointprod" ><span><?php echo $lang['admin_pointprod_list_title'];?></span></a></li>
...
<script>
$(function() {
    var flexUrl = 'index.php?con=pointprod&fun=pointorder_list_xml';
