    ...
    public function ref_addOp(){
        if(chksubmit()){
            ...
            if($rs){
                $url = array(
                        array(
                                'url'=>'index.php?con=circle_memberlevel&fun=ref_add',
                                'msg'=>L('circle_continue_add'),
                        ),
                        array(
                                'url'=>'index.php?con=circle_memberlevel&fun=ref',
                                'msg'=>L('nc_backlist'),
                        )
                );
...
Tpl::showpage('circle_memberlevel.ref_add');
    ...
    public function ref_editOp(){
        ...
        if(chksubmit()){
            ...
            if($rs){
                showMessage(L('nc_common_op_succ'), 'index.php?con=circle_memberlevel&fun=ref');
            }else{
                showMessage(L('nc_common_op_fail'));
            }
        }
...
Tpl::showpage('circle_memberlevel.ref_edit');
    ...
    public function update_cacheOp() {
        ...
        showMessage(L('nc_common_op_succ'), 'index.php?con=circle_memberlevel');
