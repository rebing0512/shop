...
class member_snsfriendControl extends BaseMemberControl {
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
            1=>array('menu_key'=>'find',    'menu_name'=>Language::get('snsfriend_findmember'), 'menu_url'=>'index.php?con=member_snsfriend&fun=find'),
            2=>array('menu_key'=>'follow',  'menu_name'=>Language::get('snsfriend_follow'), 'menu_url'=>'index.php?con=member_snsfriend&fun=follow'),
            3=>array('menu_key'=>'fan',     'menu_name'=>Language::get('snsfriend_fans'),   'menu_url'=>'index.php?con=member_snsfriend&fun=fan')
        );
