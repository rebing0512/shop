...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=goods_album&fun=list" title="返回<?php echo $lang['g_album_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form method='post' action="index.php" name="picForm" id="picForm">
    <input type="hidden" name="con" value="goods_album" />
    <input type="hidden" name="fun" value="del_more_pic" />
...
$(function(){
	...
	$('a[nc_type="delete"]').bind('click',function(){
		...
		cur_note = this;
		$.get("index.php?con=goods_album&fun=del_album_pic", {'key':$(this).attr('nc_key')}, function(data){
            if (data == 1) {
