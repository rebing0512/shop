...
function collect_flea(fav_id){
    var url = 'index.php?con=member_flea&fun=addfavorites';
...
function collect_goods(fav_id){
    var url = 'index.php?con=member&fun=addfavorites';
    $.getJSON(url, {'fav_id':fav_id}, function(data){
        if (data.done)
        {
            alert(data.msg);
    ...
    <div id="slider" style="position:absolute; left:50px">
      ...
      <div class="pic fn-left<?php if(intval($_GET['goods_id']) == $comment_goods['goods_id']){echo ' bor';} ?>">
            <span class="thumb size76">
              <i></i>
              <a href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $comment_goods['goods_id'];?>">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
      ...
      <div class="ware_info">
        ...
        <ul class="item_info">
          ...
          <li><em><?php echo $lang['flea_transfer_area'];?>:</em><a class="orange" href="index.php?con=flea_class&area_input=<?php echo $output['goods']['flea_area_id']?>"><?php echo $output['goods']['flea_area_name']?></a></li>
          <li class="rank_new">
            ...
            <span class="tb-tips">
               ...
               <a class="ico3" style="text-decoration:none; cursor:pointer;" nc_type="dialog" dialog_id="friend_add" dialog_title="<?php echo $lang['flea_oldnew_choose'];?>" uri="index.php?con=flea_class&fun=quality_inner" dialog_width="400">
      ...
      ?>
          <a class="blue" href="index.php?con=flea_class&key_input=<?php echo urlencode($val); ?>" target="_blank"><?php echo $val?></a>
          <?php }?>
          <?php }?>
          </li>
        </ul>
    ...
    <div class="col-sub">
      <a href="index.php?con=member_flea&fun=add_goods"></a>
    </div>
    ...
    <div id="seller_info" class="flea_gray mb10">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="index.php?con=member_message&fun=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/web_mail.gif"></a></p>
    </div>
    <div id="seller_info" class="flea_gray mb10">
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
             <dt><a href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_name'];?></a></dt>
             <dd><?php echo $lang['currency'];?><a href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_store_price'];?></a></dd>
           </dl>
        </div>
        <?php }?>
        <?php }?>
...
<div><?php echo $output['goods']['goods_body'];?></div>
  ...
  <div id="comments-content">
     ...
     <input type="hidden" name="con" value="flea_goods">
     <input type="hidden" name="fun" value="save_consult">
     ...
     <input type="hidden" value="" name="type_name">
       ...
       <div class="comment-add"><textarea name="content" type="text" style="width: 903px; height: 105px;"></textarea></div>
...
<div id="con_one_3" style="display:none">
    ...
    <li>
      <div class="pic"> 
        <span class="thumb size160">
          <i></i>
          <a title="<?php echo $val3['goods_name'] ?>" href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><img height="160" width="160" onload="javascript:DrawImage(this,160,160);" src="<?php echo $val3['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val3['member_id'].DS.$val3['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>"></a>
        </span>
      </div>
      <h3><a href="index.php?con=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><?php echo $val3['goods_name']?></a></h3>
  ...
  <div id="tb-detail-tips">
    <div id="J_tb-buy-tips" class="tb-buy-tips clearfix">
      ...
      <a href="index.php?con=member_flea&fun=add_goods" class="tb-pub-free" target="_blank"><?php echo $lang['flea_fee_release'];?><i><?php echo $lang['flea_enter_release'];?></i></a>      </div>
</div>
  </div>
  </div>
  <div class="fn-clear"></div>
