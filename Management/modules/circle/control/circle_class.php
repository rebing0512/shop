        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($result){
                    $url = array(
                        array(
                            'url'=>'index.php?con=circle_class&fun=class_add',
                            'msg'=>L('circle_continue_add'),
                        ),
                        array(
                            'url'=>'index.php?con=circle_class&fun=class_list',
    ...
    public function class_editOp(){
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($result){
                    showMessage(L('nc_common_op_succ'),'index.php?con=circle_class&fun=class_list');
                }else{
                    showMessage(L('nc_common_op_fail'));
                }
            }
