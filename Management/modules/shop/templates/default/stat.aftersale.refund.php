...
function update_flex(){
	$('#container').load('index.php?con=stat_aftersale&fun=get_refund_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?con=stat_aftersale&fun=get_refundlist_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?con=stat_aftersale&fun=refundlist';
