...
<div class="ncc-main">
  <div class="ncc-title">
    ...
    <h5>查看充值记录可以通过<a href="<?php echo urlShop('predeposit');?>" target="_blank">我的充值列表 </a>进行查看。</h5>
  </div>
  <form action="index.php?con=payment&fun=pd_order" method="POST" id="buy_form">
        ...
        <li payment_code="<?php echo $val['payment_code']; ?>">
          ...
          <div class="predeposit" nc_type="predeposit" style="display:none">
            <?php if ($val['payment_code'] == 'predeposit') {?>
                ...
                <p>当前预存款余额<br/>￥<?php echo $output['available_predeposit'];?><br/>不足以支付该订单<br/><a href="<?php echo SHOP_SITE_URL.'/index.php?con=predeposit';?>" class="predeposit">马上充值</a></p>
                <?php } else {?>
