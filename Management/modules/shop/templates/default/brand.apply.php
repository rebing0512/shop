  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?con=brand&fun=brand"><?php echo $lang['nc_manage'];?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?con=brand&fun=get_xml&type=apply',
        colModel : [
...
function fg_apply(id) {
    ...
    $.getJSON('index.php?con=brand&fun=brand_apply_set', {id:id}, function(data){
        if (data.state) {
