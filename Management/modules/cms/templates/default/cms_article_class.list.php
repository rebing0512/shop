    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['class_id']; ?>">
          ...
          <td class="handle-s"><a href="index.php?con=cms_article_class&fun=cms_article_class_drop&class_id=<?php echo $val['class_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a></td>
	...
	$('.flex-table').flexigrid({
        ...
        buttons : [
                   {display: '<i class="fa fa-plus"></i>新增分类', name : 'add', bclass : 'add', title : '新增分类', onpress : fg_operation },
                    ...
                    location.href = 'index.php?con=cms_article_class&fun=cms_article_class_drop&class_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
                }
               ]
		});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=cms_article_class&fun=cms_article_class_add';
    }
}
</script>