...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=admin&fun=admin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="admin_form" method="post" action='index.php?con=admin&fun=admin_edit&admin_id=<?php echo $output['admininfo']['admin_id'];?>'>
