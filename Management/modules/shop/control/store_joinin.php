...
class store_joininControl extends SystemControl{
    ...
    public function edit_infoOp() {
        ...
        if (chksubmit()) {
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?con=store_joinin&fun=edit_info');
        }
    ...
    public function edit_helpOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('nc_common_save_succ'),'index.php?con=store_joinin&fun=help_list');
            } else {
