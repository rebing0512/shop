  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">商城seo描述</dt>
            <dd class="opt">
                <textarea id="microshop_seo_description" name="microshop_seo_description" class="input-txt"><?php echo $output['list_setting']['microshop_seo_description'];?></textarea>
                <p class="notic"></p>
            </dd>
        </dl>
      <dl class="row">
