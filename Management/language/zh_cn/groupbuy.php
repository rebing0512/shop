 ...
 * index
 */
$lang['groupbuy_index_manage']		= '特卖管理';
$lang['groupbuy_index_manage_subhead']	= '实物商品特卖促销活动相关设定及管理';
...
$lang['groupbuy_price_list']		= '特卖价格区间';
...
$lang['day']						= '日';
$lang['hour']						= '时';
$lang['groupbuy_index_state']		= '特卖状态';
 ...
 * 页面说明
 **/
$lang['groupbuy_template_help1'] = '点击活动的管理按钮查看活动详细信息，对特卖申请进行审批管理';
$lang['groupbuy_template_help2'] = '未开始的活动可以直接删除，删除后该活动下的所有特卖信息将被同时删除';
$lang['groupbuy_template_help3'] = '活动开始后可以点击关闭按钮手动关闭该活动';
$lang['groupbuy_template_help4'] = '推荐特卖商品到首页，请到特卖活动管理页面点亮推荐列下的对勾';
$lang['groupbuy_template_add_help1'] = '活动时间不能重叠，新活动的开始时间必须大于已有活动的结束时间';
$lang['groupbuy_template_add_help2'] = '报名截止时间必须小于活动开始时间';
$lang['groupbuy_start_time_explain'] = '特卖活动开始时间不能早于';
$lang['groupbuy_class_help1'] = '特卖分类后台为2级分类，前台默认显示1级，如需扩展需要二次开发';
$lang['groupbuy_area_help1'] = '特卖地区后台为3级分类，前台默认显示1级，如需扩展需要二次开发';
$lang['groupbuy_price_range_help1'] = '前台特卖按价格筛选的区间，各个区间段的金额不要发生重叠';
$lang['groupbuy_index_help1']		= "点击导航菜单中的'返回列表'链接返回活动列表页";
$lang['groupbuy_index_help2']		= '特卖信息审核后才会出现在前台页面';
...
$lang['groupbuy_recommend_help1'] = '此页面显示的是已经通过审核的正在特卖中的商品，只能进行推荐操作';
...
$lang['ensure_verify_success'] = '确认审核通过该特卖活动?';
$lang['ensure_verify_fail'] = '确认审核失败该特卖活动?';
$lang['op_close'] = '结束';
$lang['ensure_close'] = '确认结束该特卖活动?';
...
$lang['start_time_overlap'] = '特卖活动时间有重叠请您重新选择特卖开始时间';
/**
 * 提示信息
 */

$lang['admin_groupbuy_unavailable'] = '特卖功能尚未开启，是否自动开启';
$lang['groupbuy_template_add_success'] = '特卖活动添加成功';
$lang['groupbuy_template_add_fail'] = '特卖活动添加失败';
$lang['groupbuy_tempalte_drop_success'] = '特卖活动删除成功';
$lang['groupbuy_template_drop_fail'] = '特卖活动删除失败';
$lang['groupbuy_tempalte_close_success'] = '特卖活动关闭成功';
$lang['groupbuy_template_close_fail'] = '特卖活动关闭失败';
$lang['groupbuy_verify_success'] = '特卖审核操作成功';
$lang['groupbuy_verify_fail'] = '特卖审核操作失败';
$lang['groupbuy_close_success'] = '特卖结束成功';
$lang['groupbuy_close_fail'] = '特卖结束失败';
$lang['groupbuy_class_add_success'] = '特卖分类添加成功';
$lang['groupbuy_class_add_fail'] = '特卖分类添加失败';
$lang['groupbuy_class_edit_success'] = '特卖分类编辑成功';
$lang['groupbuy_class_edit_fail'] = '特卖分类编辑失败';
$lang['groupbuy_class_drop_success'] = '特卖分类删除成功';
$lang['groupbuy_class_drop_fail'] = '特卖分类删除失败';
$lang['groupbuy_area_add_success'] = '特卖地区添加成功';
$lang['groupbuy_area_add_fail'] = '特卖地区添加失败';
$lang['groupbuy_area_edit_success'] = '特卖地区编辑成功';
$lang['groupbuy_area_edit_fail'] = '特卖地区编辑失败';
$lang['groupbuy_area_drop_success'] = '特卖地区删除成功';
$lang['groupbuy_area_drop_fail'] = '特卖地区删除失败';
$lang['groupbuy_price_range_add_success'] = '特卖价格区间添加成功';
$lang['groupbuy_price_range_add_fail'] = '特卖价格区间添加失败';
$lang['groupbuy_price_range_edit_success'] = '特卖价格区间编辑成功';
$lang['groupbuy_price_range_edit_fail'] = '特卖价格区间编辑失败';
$lang['groupbuy_price_range_drop_success'] = '特卖价格区间删除成功';
$lang['groupbuy_price_range_drop_fail'] = '特卖价格区间删除失败';

$lang['groupbuy_close_confirm'] = '确认关闭特卖活动？关闭后无法再次开启。';
