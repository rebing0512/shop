...
<div class="nctouch-main-layout">
 <div class="alert " style="clear:both;">
  <div class="alert">
      <h4>提示信息：</h4>
      <ul>
        <li>您已将本站账号<em>“<?php echo $_SESSION['member_name'];?>”</em>与QQ号码<em>“<?php echo $output['member_qqinfoarr']['nickname'];?>”</em>绑定</li>
    ...
    <dl class="mt5">
          ...
          <ul id="kj_ul" class="mt5 mb5">
            <li><a href="javascript:void(0)"><i class="kj-04"></i><p>解除已绑定账号？</p></a> <span class="jcbtn" type="qq">确认解除</span></li>
      ...
      <form>
        <ul class="form-box">
            ...
            <div class="form-btn"><a href="javascript:void(0);" class="btn" id="nextform" type="qq">修改密码并解除</a></div>
       </form>     
      </div>
</div>
