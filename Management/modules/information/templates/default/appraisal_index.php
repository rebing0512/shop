...
<script type="text/javascript">
    $(function(){
        $("#flexigrid").flexigrid({
            url: 'index.php?con=mb_appraisal&fun=get_xml',
            colModel : [
            ...
            buttons : [
                {display: '<i class="fa fa-plus"></i>新增横图信息信息', name : 'add', bclass : 'add', title : '添加新的横图信息', onpress : fg_operate }
            ],
            searchitems : [
    ...
    function fg_operate(name, grid) {
        if (name == 'add') {
            window.location.href = 'index.php?con=mb_appraisal&fun=add';
        }else if (name == 'delete') {
    ...
    function fg_delete(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "index.php?con=mb_appraisal&fun=delete",
            data: "del_id="+id,
