...
.dialog-share .bottom .button { color: #FFF; background-color: #FF4000; height: 28px; width: 80px; border: solid 1px #B22D00; cursor: pointer;}
...
<div class="dialog-share">
  <form method="post" action="index.php?con=member_snsindex&fun=sharegoods" id="sharegoods_form">
    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        ...
        <dl class="goods-intro">
          ...
          <dd><?php if (in_array($output['goods_info']['goods_promotion_type'], array(1,2))) {?><span><?php echo $output['goods_info']['goods_promotion_type'] == 1 ? '特卖' : '限时';?></span><?php }?><strong>￥<?php echo ncPriceFormat($output['goods_info']['goods_promotion_price']); ?></strong></dd>
        </dl>
      </div>
...
<div class="bottom"><a href="javascript:void(0);" nc_type="finishbtn" data-param='{"apikey":"@apikey"}' class="mini-btn"><?php echo $lang['sharebind_list_finishbind'];?></a><span><?php echo $lang['sharebind_list_unfinishedbind'];?><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/api.php?con=sharebind&type=@apikey"><?php echo $lang['sharebind_list_againbind'];?></a></span>
</div>
</div>
</textarea>
