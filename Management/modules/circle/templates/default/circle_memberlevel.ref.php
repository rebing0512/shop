  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?con=circle_memberlevel"><?php echo $lang['circle_defaultlevel'];?></a></li>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=circle_memberlevel&fun=ref_add';
    }
}
</script>
