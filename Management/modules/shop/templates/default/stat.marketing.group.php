...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>列表一为时间段内进行中的特卖活动息</li>
      <li>列表二为时间段内特卖活动生成的有效订单记录，默认按照“下单商品数”降序排列</li>
    </ul>
  </div>
...
function update_flex(){
	//加载统计列表
    $("#glist").flexigrid({
        url: 'index.php?con=stat_marketing&fun=get_grouplist_xml&'+$("#formSearch").serialize(),
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '特卖名称', name : 'groupbuy_name', width : 150, sortable : false, align: 'left'},
            ...
            {display: '特卖状态', name : 'groupbuy_state_text',  width : 60, sortable : true, align: 'center'},
            ...
            {display: '特卖价', name : 'groupbuy_price',  width : 60, sortable : true, align: 'center'},
        ...
        searchitems : [
            {display: '特卖名称', name : 'groupbuy_name'},
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?con=stat_marketing&fun=get_groupgoods_xml&'+$("#formSearch").serialize(),
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
...
$(function () {
	...
	$('#ncsubmit').click(function(){
	    $("#glist").flexOptions({url: 'index.php?con=stat_marketing&fun=get_grouplist_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    $("#flexigrid").flexOptions({url: 'index.php?con=stat_marketing&fun=get_groupgoods_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
	    update_flex();
    });
});
function fg_operation(name, bDiv){
    var stat_url = 'index.php?con=stat_marketing&fun=groupgoods';
