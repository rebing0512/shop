...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdminMobile('mb_payment', 'payment_save');?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><em>*</em>商户id(partner ID)</label>
        </dt>
        <dd class="opt">
      ...
      <?php } ?>
      <?php if ($output['payment']['payment_code'] == 'tenpay') { ?>
      <dl class="row">
        <dt class="tit">
          <label><em>*</em>商户号(partnerid)</label>
        </dt>
        <dd class="opt">
          <input name="tenpay_partnerid" id="tenpay_partnerid" value="<?php echo $output['payment']['payment_config']['tenpay_partnerid'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input name="tenpay_partnerkey" id="tenpay_partnerkey" value="<?php echo $output['payment']['payment_config']['tenpay_partnerkey'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="jdpay_partnerid" id="jdpay_partnerid" value="<?php echo $output['payment']['payment_config']['jdpay_partnerid'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input name="jdpay_partnerkey" id="jdpay_partnerkey" value="<?php echo $output['payment']['payment_config']['jdpay_partnerkey'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
    ...
    <?php if ($output['payment']['payment_code'] == 'tenpay') { ?>
        ...
        messages : {
            tenpay_partnerkey  : {
                required : '<i class="fa fa-exclamation-circle"></i>商户密钥不得为空'
            },
            tenpay_partnerid  : {
                required : '<i class="fa fa-exclamation-circle"></i>商户号不得为空'
            }
        }
    <?php } ?>
    <?php if ($output['payment']['payment_code'] == 'jdpay') { ?>
