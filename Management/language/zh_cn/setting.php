...
$lang['seach_set']        = '搜索设置';
$lang['suo_dump']   	= '更新索引';
$lang['suo_keyword']   	= '关键字设置';
$lang['web_set_subhead'] = '网站全局内容基本选项设置';
$lang['seach_set_subhead'] = '资讯搜索内容基本选项设置';
...
$lang['groupbuy_allow'] = '特卖';
$lang['groupbuy_isuse_notice']    = '特卖功能启用后，商家通过活动发布特卖商品，进行促销';
...
$lang['operating_unit']                     = '运营单位';
$lang['operating_unit_notice']              = '填写运营单位名称';
$lang['site_kuaidi']                    	= '平台快递100接口';
$lang['site_kuaidi_notice']             	= '填写快递100接口key';
$lang['site_qq']                    		= '平台qq客服';
$lang['site_qq_notice']             		= '填写平台qq客服';
$lang['web_url']                     		= '运营网址';
$lang['web_url_notice']              		= '填写运营网址格式如:http://www.xxx.com';
$lang['site_phone']                         = '平台客服联系电话';
$lang['site_phone_notice']                  = '商家中心右下侧显示，方便商家遇到问题时咨询，多个请用半角逗号 "," 隔开';
$lang['site_bank_account']                  = '平台汇款账号';
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:,开户行:中国银行天津分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 shop@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 shop';
$lang['smtp_user_pwd']           = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip']       = 'shop@163.com邮件的密码，如 123456';
...
$lang['seo_set_tips2'] 	= '名称 {name}，（应用范围：特卖名称、商品名称、品牌名称、文章标题、分类名称）';
...
$lang['seo_set_group_content'] 		= '特卖内容';
