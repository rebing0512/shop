...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?con=store_contract&fun=applypay">
	<input type="hidden" id="act" name="con" value="store_contract"/>
