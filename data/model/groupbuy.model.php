...
class groupbuyModel extends Model{
    ...
    /**
     * 根据特卖编号读取特卖信息
     * @param array $groupbuy_id 特卖活动编号
    ...
    /**
     * 根据商品编号查询是否有可用特卖活动，如果有返回特卖信息，没有返回null
     * @param int $goods_id
    ...
    /**
     * 根据商品编号查询是否有可用特卖活动，如果有返回特卖活动，没有返回null
        ...
        switch ($groupbuy_info['state']) {
            ...
            case self::GROUPBUY_STATE_NORMAL:
                if($groupbuy_info['start_time'] > TIMESTAMP) {
                    ...
                    $groupbuy_info['count_down_text'] = '距特卖开始';
                    ...
                    $groupbuy_info['count_down_text'] = '距特卖结束';
    ...
    protected function getCachingDataByQuery($key) {
        ...
        case 'groupbuy_vr_classes': // 虚拟特卖分类
        ...
        case 'groupbuy_vr_cities': // 虚拟特卖地区
            // 一级地区 城市
