...
<div class="eject_con">
  <div class="adds">
    <div id="warning"></div>
    <form method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?con=member_address&fun=address" id="address_form" target="_parent">
...
$(document).ready(function(){
    ...
    $('#zt').on('click',function(){
    	...
    	ajax_form('daisou','使用代收货（自提）', '<?php echo SHOP_SITE_URL;?>/index.php?con=member_address&fun=delivery_add', '900',0);
    });
});
