...
class member_returnControl extends mobileMemberControl {
    ...
    *退款退货详情
    */
    public function member_return_infoOp() {
         Tpl::output('web_seo',C('site_name').' - '.'退货详情');
         Tpl::showpage('member_return_info');
    }
     /*
    *退款退货详情
    */
    public function member_return_shipOp() {
         Tpl::output('web_seo',C('site_name').' - '.'退货发货');
         Tpl::showpage('member_return_ship');
    }
