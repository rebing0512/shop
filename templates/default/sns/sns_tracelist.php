...
<div id="lazymodule">
  ...
  <div class="sns-norecord ml200"><i class="trace-ico pngFix"></i><span><?php echo $lang['sns_trace_nohave_self_1'];?><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_snsfriend&fun=find"><?php echo $lang['sns_trace_nohave_self_2'];?></a><?php echo $lang['sns_trace_nohave_self_3'];?></span></div>
  <?php } else { ?>
