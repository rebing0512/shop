...
<div style="margin-top:47px;margin-bottom: 50px" class="main">
    ...
    <div style="background-color: white;color: black;font-size: .8rem;">
        <a href="tel:0591-83788999">
            <p class="dlp"><i class="phone"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/images/phone.png"></i><span style="left: 0;">专家电话</span><span style="position: absolute;right: 0;padding-right: 10px;color: #8e8e8e;">139-0592-9092</span></p>
        </a>
    </div>
</div>
