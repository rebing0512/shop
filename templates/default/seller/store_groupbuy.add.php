...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?con=store_groupbuy&fun=groupbuy_save" method="post" enctype="multipart/form-data">
    <dl>
...
<?php if (!$output['isOwnShop']) { ?>
          <?php echo '特卖开始时间不能大于'.date('Y-m-d H:i', $output['current_groupbuy_quota']['end_time']);?>
          </p>
<?php } ?>
    ...
    <dl>
      ...
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
        ...
        <p class="hint"><?php echo $lang['groupbuy_goods_explain'];?></br><span class="red">特卖生效后该商品的所有规格SKU都将执行统一的特卖价格</span></p>
        </dd>
    </dl>
...
<?php } ?>
            ...
            groupbuy_price: {
                ...
                lessThanGoodsPrice: '<i class="icon-exclamation-sign"></i>特卖价格必须小于商品价格',
