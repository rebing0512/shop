  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?con=circle_setting&fun=seo"><?php echo $lang['circle_setting_seo'];?></a></li>
        <li><a href="index.php?con=circle_setting&fun=sec"><?php echo $lang['circle_setting_sec'];?></a></li>
        <li><a href="index.php?con=circle_setting&fun=exp"><?php echo $lang['circle_setting_exp'];?></a></li>
        <li><a href="index.php?con=circle_setting&fun=super_list">超级管理员</span></a></li>
      </ul>
    </div>
  </div>
