    ...
    public function payment_saveOp() {
        ...
        switch ($_POST['payment_code']) {
            ...
            case 'wxpay_jsapi':
             ...
             case 'tenpay':
                $payment_config = array(
                    'tenpay_partnerid'     => $_POST['tenpay_partnerid'],
                    'tenpay_partnerkey' => $_POST['tenpay_partnerkey'],
                );
            case 'jdpay':
            $payment_config = array(
                'jdpay_partnerid'     => $_POST['jdpay_partnerid'],
                'jdpay_partnerkey' => $_POST['jdpay_partnerkey'],
            );
                break;
            default:
