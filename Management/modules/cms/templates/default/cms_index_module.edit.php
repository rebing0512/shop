...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=cms_index&fun=cms_index" title="返回模板"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" action="index.php?con=cms_index&fun=save_page_module">
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <ul class="article-tag-list">
          ...
          <li nctype="btn_tag_select" data-tag-id="<?php echo $value['tag_id'];?>"><a href="<?php echo CMS_SITE_URL;?>/index.php?con=article&fun=article_tag_search&tag_id=<?php echo $value['tag_id'];?>" ><?php echo $value['tag_name'];?></a><i></i></li>
          <?php } ?>
          <?php } ?>
        </ul>
      </dd>
...
<div id="dialog_module_image_edit" style="display:none;">
  ...
  <form action="index.php?con=cms_index&fun=image_upload" method="post">
    <div class="ncap-form-default">
