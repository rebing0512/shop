    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['navigation_id']; ?>">
          ...
          <td class="handle-s"><a href="index.php?con=cms_navigation&fun=cms_navigation_drop&navigation_id=<?php echo $val['navigation_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a></td>
        ...
        buttons : [
            ...
            },
            {
                ...
                onpress : function() {
                    ...
                    location.href = 'index.php?con=cms_navigation&fun=cms_navigation_drop&navigation_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ]
    });
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=cms_navigation&fun=cms_navigation_add';
    }
}
</script>