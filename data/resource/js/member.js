...
//	        window.location.href=uri + '&' + name + '=' + items;
    ...
    $('*[nc_type="gselector"]').focus(function(){
        ...
        ajax_form(id, title, SITEURL + '/index.php?con=store_groupbuy&fun=' + op + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width);
        return false;
    });
    ...
    $('span[nc_type="order_by"]').click(function(){
        ...
        if(location.pathname.indexOf('/adminmin/')>-1)
        {
                location.assign(SITEURL + '/adminmin/index.php?' + params.join('&'));
                return;
        }
