...
<!-- 简介添加 --> 
      <dl class="row">
        <dt class="tit">
          <label for="adv_summary"><?php echo $lang['adv_summary'];?></label>
        </dt>
        <dd class="opt">
          <textarea type="text" name="adv_summary" id="adv_summary" class="tarea"><?php echo $v['adv_summary']?></textarea>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
<!-- 简介添加 -->  
      ...
      <dl class="row">
        ...
        <dd class="opt">
       <?php switch ($ap_v['ap_class']){ case '0': echo $lang['adv_pic']; break; case '1': echo $lang['adv_word']; break; case '2': echo $lang['adv_slide']; break; case '3': echo "Flash"; break;case '4': echo "多图轮播"; break;case '5': echo "wap端多图轮播"; break;} ?>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <?php break; case '4': $pic_content = unserialize($v['adv_content']); $pic = $pic_content['adv_pic']; $url = $pic_content['adv_pic_url'];  ?>
         <dl class="row" id="adv_pic">
        <dt class="tit">
          <input type="hidden" name="mark" value="0">
          <label for="file_adv_pic"><?php echo $lang['adv_img_upload'];?></label>
      ...
      <dl class="row" id="adv_pic_url">
       ...
       <?php break; case '5': $pic_content = unserialize($v['adv_content']); $pic = $pic_content['adv_pic']; $url = $pic_content['adv_pic_url'];  ?>
         <dl class="row" id="adv_pic">
        <dt class="tit">
          <input type="hidden" name="mark" value="0">
          <label for="file_adv_pic"><?php echo $lang['adv_img_upload'];?></label>
