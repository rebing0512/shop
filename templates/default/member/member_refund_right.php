<?php defined('TTShop') or exit('Access Invalid!');?>
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-order">
      ...
      <dl class="line">
        <dt>订单编号：</dt>
        <dd><a target="_blank" href="index.php?con=member_order&fun=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a>
      ...
      <dl>
        <dt>物流单号：</dt>
        <dd><a target="_blank" href="index.php?con=member_order&fun=search_deliver&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['shipping_code'];?></a>
