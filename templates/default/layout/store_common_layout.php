...
<div class="header-wrap">
  ...
  <div class="heade_store_info">
    ...
    <div class="head-search-bar" id="search">
        <form class="search-form" method="get" action="<?php echo SHOP_SITE_URL;?>" name="formSearch" id="formSearch">
          <input name="con" id="search_act" value="search" type="hidden">
          <input name="keyword" value="" type="hidden">
          <input style="color: rgb(153, 153, 153);" name="inkeyword" id="inkeyword" class="input-text" value="" x-webkit-speech="" onwebkitspeechchange="foo()" x-webkit-grammar="builtin:search" placeholder="想找什么商品？" lang="zh-CN" type="text">
