...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?con=pointprod&fun=order_ship&id=<?php echo $_GET['id']; ?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="index.php?con=pointprod&amp;fun=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
