...
<div class="page">
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="operating_unit"><?php echo $lang['operating_unit'];?></label>
        </dt>
        <dd class="opt">
          <input id="operating_unit" name="operating_unit" value="<?php echo $output['list_setting']['operating_unit'];?>" class="input-txt" type="text" />
          <p class="notic"><?php echo $lang['operating_unit_notice'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label for="web_url"><?php echo $lang['web_url'];?></label>
        </dt>
        <dd class="opt">
          <input id="web_url" name="web_url" value="<?php echo $output['list_setting']['web_url'];?>" class="input-txt" type="text" />
          <p class="notic"><?php echo $lang['web_url_notice'];?></p>
        </dd>
      </dl>
       <dl class="row">
        <dt class="tit">
          <label for="site_qq"><?php echo $lang['site_qq'];?></label>
        </dt>
        <dd class="opt">
          <input id="site_qq" name="site_qq" value="<?php echo $output['list_setting']['site_qq'];?>" class="input-txt" type="text" />
          <p class="notic"><?php echo $lang['site_qq_notice'];?></p>
        </dd>
      </dl>
       <dl class="row">
        <dt class="tit">
          <label for="site_kuaidi"><?php echo $lang['site_kuaidi'];?></label>
        </dt>
        <dd class="opt">
          <input id="site_kuaidi" name="site_kuaidi" value="<?php echo $output['list_setting']['site_kuaidi'];?>" class="input-txt" type="text" />
          <p class="notic"><?php echo $lang['site_kuaidi_notice'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
