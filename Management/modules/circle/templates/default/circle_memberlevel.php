...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?con=circle_memberlevel&fun=ref"><?php echo $lang['circle_memberlevelref'];?></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" id="clmdForm" name="clmdForm">
    ...
    <div class="ncap-form-all">
      ...
      <div class="fix-bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['nc_submit'];?></a>  <a href="index.php?con=circle_memberlevel&fun=update_cache" class="ncap-btn-big ncap-btn-orange" ><?php echo $lang['nc_circle_cache'];?></a></div>
    </div>
  </form>
</div>
<script>
