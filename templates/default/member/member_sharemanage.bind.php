...
<div class="wrap">
  ...
  <ul class="bind-account-list">
    ...
    <li>
      <div class="account-item"><span class="website-icon"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/shareicon/shareicon_<?php echo $k;?>.png"></span>
        <dl>
...
$(function(){
	...
	$("[nc_type='unbindbtn']").bind('click',function(){
	    ...
	    ajax_get_confirm(confirm_tip,'<?php echo SHOP_SITE_URL;?>/index.php?con=member_sharemanage&fun=unbind&type='+data_str.apikey);
	});
