...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=adv&fun=adv&ap_id=<?php echo $_GET['ap_id'];?>" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['adv_index_manage'];?> - 新增广告XXX</h3>
...
<!-- 简介添加 --> 
      <dl class="row">
        ...
        <dd class="opt">
          <textarea type="text" name="adv_summary" id="adv_summary" class="tarea"></textarea>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(function(){
    ...
    $('#ap_id').change(function(){
        ...
        if(ap_type == '0' ||ap_type == '4'||ap_type == '5'){
    	    $('#adv_pic').show();
            $('#adv_pic_url').show();
            $('#adv_word').hide();
            $('#adv_word_url').hide();
