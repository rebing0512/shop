...
class statistics_industryControl extends BaseSellerControl{
    ...
    private function profile_menu($menu_key=''){
        $menu_array = array(
            1=>array('menu_key'=>'hot','menu_name'=>'同行热卖','menu_url'=>'index.php?con=statistics_industry&fun=hot'),
            2=>array('menu_key'=>'price','menu_name'=>'行业价格分布','menu_url'=>'index.php?con=statistics_industry&fun=price')
        );
