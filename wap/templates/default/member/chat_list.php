...
<% for (var k in list) { %>
    ...
    <li> <a href="<%=ApiUrl%>/index.php?con=member_chat&t_id=<%=k%>&t_name=<%=list[k].u_name%>">
...
<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/list/chat_list.js"></script>
