...
<?php if ($output['isOwnShop']) { ?>
  <!-- <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:100px" class="ncbtn ncbtn-mint" title="新增虚拟商品特卖"><i class="icon-plus-sign"></i>新增虚拟特卖</a> -->
...
<?php } else { ?>
  ...
  <!-- <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:200px" class="ncbtn ncbtn-mint" title="新增虚拟商品特卖"><i class="icon-plus-sign"></i>新增虚拟特卖</a> -->
...
<div class="alert alert-block mt10">
  <ul class="mt5">
    <li>1、点击新增特卖按钮可以添加特卖活动</li>
    <li>2、如发布虚拟商品的特卖活动，请点击新增虚拟特卖按钮</li>
  </ul>
</div>
<?php } else { ?>
<div class="alert alert-block mt10">
  ...
  <ul class="mt5">
    ...
    <li>2、点击新增特卖按钮可以添加特卖活动</li>
    <li>3、如发布虚拟商品的特卖活动，请点击新增虚拟特卖按钮</li>
...
<table class="search-form">
  <form method="get">
    <input type="hidden" name="con" value="store_groupbuy" />
    <tr>
      <td>&nbsp;</td>
      <th>特卖类型</th>
      <td class="w100">
