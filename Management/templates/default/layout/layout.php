...
<script type="text/javascript">
  //全局变量
var GV = {
    DIMAUB: "<?php echo SHOP_SITE_URL;?>/adminmin/",
  JS_ROOT: "<?php echo SHOP_SITE_URL;?>/adminmin/resource/js/"
};
...
<script src="<?php echo ADMIN_RESOURCE_URL;?>/js/wind.js" type="text/javascript"></script>
