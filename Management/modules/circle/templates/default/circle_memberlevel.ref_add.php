...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=circle_memberlevel&fun=ref" title="返回<?php echo $lang['circle_memberlevelref'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
