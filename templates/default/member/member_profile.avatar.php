...
<div class="wrap">
  ...
  <form action="<?php echo SHOP_SITE_URL;?>/index.php?con=member_information&fun=upload" enctype="multipart/form-data" id="form_avaster" method="post">
  ...
  <?php }else{?>
  <form action="<?php echo SHOP_SITE_URL;?>/index.php?con=member_information&fun=cut" id="form_cut" method="post">
    <input type="hidden" name="form_submit" value="ok" />
