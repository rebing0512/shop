...
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_image'); } else { echo urlShop('store_goods_add', 'save_image');}?>">
  ...
  <div class="ncsc-form-goods-pic">
    <div class="container">
      ...
      <div class="ncsc-goodspic-list">
        ...
        <div class="ncsc-select-album">
          <a class="ncbtn" href="index.php?con=store_album&fun=pic_list&item=goods_image&color_id=<?php echo $value['sp_value_id'];?>" nctype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
    ...
    <li>3. 每种颜色最多可上传9张图片或从图片空间中选择已有的图片，上传后的图片也将被保存在店铺图片空间中以便其它使用。</li>
