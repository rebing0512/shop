...
class cms_specialControl extends SystemControl{
    ...
    const LINK_CMS_SPECIAL = 'index.php?con=cms_special&fun=cms_special_list';
    //专题状态草稿箱
...
Tpl::showpage('cms_special.detail', 'null_layout');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'special_list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?con=cms_special&fun=cms_special_list'),
            'special_add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=cms_special&fun=cms_special_add'),
