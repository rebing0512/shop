...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?con=help_store&fun=help_store" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?con=help_store&fun=upload_pic&item_id=<?php echo $output['help']['help_id']?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('index.php?con=help_store&fun=del_pic&file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
